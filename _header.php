...
<html lang="en">
	<head>
		...
		<title>Pokemon Helios RPG - Online Pokemon MMORPG</title>
		...
		<link rel="stylesheet" href="/css/style<?=$eventStyle.$style?>.css?ver=<?=$version?>">
	</head>
...
<nav class="navbar navbar-default" role="navigation">
	<div class="container-fluid">
		...
		<div class="navbar-header">
		  ...
		  <a class="navbar-brand logo" href="http://pkmnhelios.net/membersarea.php"></a>
		</div>
		...
		<ul class="nav navbar-nav navbar-left">
            ...
            <li class="dropdown">
				...
				<ul class="dropdown-menu" role="menu">
					...
					<li><a href="http://forums.pkmnhelios.net/">Forum</a></li>
				</ul>
			</li>
            ...
            <li class="dropdown">
				...
				<ul class="dropdown-menu" role="menu">
					...
					<li><a href="/online.php">Online members
						<span class="count online">&nbsp; - &nbsp;<?=$online?></span></a></li>
					<li><a href="/chatroom.php" target="_blank">Chatroom</a></li>
					<li><a href="http://www.facebook.com/pkmnheliosrpg">Facebook</a></li>
...
?>
		...
		<div class="ads-one" style="text-align: center;">
			...
			<!-- Pokemon Thunder RPG --> 
			<ins class="adsbygoogle" style="display:inline-block;width:728px;height:90px" data-ad-client="ca-pub-5362441234156231" data-ad-slot="3261811300"></ins> 
			<script> (adsbygoogle = window.adsbygoogle || []).push({});</script>
		</div>
		
		<div style="display:none;" class="ads-one-mobile">
			<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
			<!-- mobile -->
...
<?php else: ?>
	<div class="header">
		<div class="wrap">
			...
			<ul class="social">
				<li><a href="http://www.youtube.com/channel/UCj4fDJ7M1rd7HMXurzqHlLA"><span><?=$lang['social_yt']?></span></a></li>
				<li><a href="https://plus.google.com/113426748964678152778"><span><?=$lang['social_gp']?></span></a></li>
				<li><a href="https://www.facebook.com/pkmnheliosrpg"><span><?=$lang['social_fb']?></span></a></li>
				<li><a href="https://twitter.com/PokemonHelios"><span><?=$lang['social_tw']?></span></a></li>
				<li><a href="http://robylayouts.com" alt="<?=$lang['social_rl_1']?>"><span><?=$lang['social_rl_2']?></span></a></li>
			</ul>
			
			<ul class="menu">
				<li><a href="login.php"><span></span><?=$lang['menu_login']?></a></li>
				<li><a href="chatroom.php"><span></span><?=$lang['menu_chatroom']?></a></li>
				<li><a href="register.php"><span></span><?=$lang['menu_register']?></a></li>
				<li><a href="index.php"><span></span><?=$lang['menu_news']?></a></li>
			</ul>
		</div>	
		...
		<ul class="lang">
			<li class="beta"><?=$lang['lang_beta']?></li>
			<li><a href="?lang=en" title="<?=$lang['lang_en']?>"><img src="images/lang/en.png"></a></li>	
			<li><a href="?lang=es" title="<?=$lang['lang_es']?>"><img src="images/lang/es.png"></a></li>	
			<li><a href="?lang=ph" title="<?=$lang['lang_ph']?>"><img src="images/lang/ph.png"></a></li>	
			<li><a href="?lang=lv" title="<?=$lang['lang_lv']?>"><img src="images/lang/lv.png"></a></li>	
		</ul>
	</div>
	...
	<div class="ads2">
		<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
		<!-- Beta HELIOS --> 
		<ins class="adsbygoogle" style="display:inline-block;width:300px;height:600px" data-ad-client="ca-pub-5362441234156231" data-ad-slot="9792254508"></ins> 
		<script> (adsbygoogle = window.adsbygoogle || []).push({}); </script>
	</div>
<?php endif; ?>