				...
				<td>
					...
					<div class="login">
						...
						<form method="post" action="" autocomplete="off">
							<input type="text" value="<?=$username?>" name="username" placeholder="<?=$lang['login_username']?>" autofocus="on">
							<input type="password" name="password" placeholder="<?=$lang['login_password']?>">
							<input type="submit" name="submit" value="log in" class="btn">
										
							<ul class="nav">
								<li><a href="password_forgot.php"><?=$lang['login_forgot']?></a></li>
								<li><a href="register.php"><?=$lang['login_start']?></a></li>
							</ul>
										
							<div class="footer">
								<p class="online"><?=$lang['login_online']?><?=number_format($online)?></p>
								<p class="total"><?=$lang['login_total']?><?=number_format($usersTotal)?></p>
							</div>
						</form>
					</div>
