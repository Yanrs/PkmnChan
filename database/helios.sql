...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 12, 2015 at 08:16 PM
...
CREATE TABLE IF NOT EXISTS `auction_pokemon` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `owner_id` int(11) NOT NULL,
  `owner_username` varchar(200) NOT NULL,
...
(1, 1, 'sadsadsad asdsa dasd asd', '2015-01-25 14:52:26');
...
CREATE TABLE IF NOT EXISTS `evolution` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci AUTO_INCREMENT=5081 ;
...
(3, 'My PokeBox', 5298),
(4, 'Trade Center', 707),
(5, 'Global Buy/Sell', 1627),
(6, 'Battle Training', 1015),
(7, 'ChatRoom', 263),
(8, 'Forums', 0),
(9, 'Online Members', 1090),
(10, 'Member List', 2005);
...
CREATE TABLE IF NOT EXISTS `lucky_hour` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `mines` (`id`, `name`, `exp`, `ore`) VALUES
(1, 'Asahina Mines', '0', 'gold'),
(2, 'Helios Mines', '5000', 'gold');
...
CREATE TABLE IF NOT EXISTS `mine_shop` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `numbergame` (
...
CREATE TABLE IF NOT EXISTS `offer_pokemon` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `tid` int(11) NOT NULL,
  `oid` int(11) NOT NULL,
  `uid` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `pokedex` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci AUTO_INCREMENT=5245 ;

--
-- Dumping data for table `pokedex`
--

INSERT INTO `pokedex` (`id`, `name`, `attack`, `spattack`, `def`, `spdef`, `hp`, `speed`, `evolution`, `level`, `type1`, `type2`, `exp`, `num`, `move1`, `move2`, `move3`, `move4`) VALUES
(1, 'Bulbasaur', 49, 65, 49, 65, 45, 45, 'Ivysaur', 16, 'Grass', 'Poison', 64, 1, 'Tackle', 'Growl', 'Leech Seed', 'Vine Whip'),
(2, 'Ivysaur', 62, 80, 63, 80, 60, 60, 'Venusaur', 32, 'Grass', 'Poison', 141, 2, 'Vine Whip', 'Poison Powder', 'Razor Leaf', 'Growth'),
(3, 'Venusaur', 82, 100, 83, 100, 80, 80, 'Venusaur', 32, 'Grass', 'Poison', 208, 3, 'Razor Leaf', 'Growth', 'Sleep Powder', 'Solar Beam'),
(4, 'Charmander', 52, 60, 43, 50, 39, 65, 'Charmeleon', 16, 'Fire', NULL, 65, 4, 'Scratch', 'Growl', 'Ember', 'Leer'),
(5, 'Charmeleon', 64, 80, 58, 65, 58, 80, 'Charizard', 36, 'Fire', NULL, 142, 5, 'Leer', 'Rage', 'Slash', 'Flamethrower'),
(6, 'Charizard', 84, 109, 78, 85, 78, 100, 'Charizard', 36, 'Fire', 'Flying', 209, 6, 'Rage', 'Slash', 'Flamethrower', 'Fire Spin'),
(7, 'Squirtle', 48, 50, 65, 64, 44, 43, 'Wartortle', 16, 'Water', NULL, 66, 7, 'Tackle', 'Tail Whip', 'Bubble', 'Water Gun'),
(8, 'Wartortle', 63, 65, 80, 80, 59, 58, 'Blastoise', 32, 'Water', NULL, 143, 8, 'Water Gun', 'Bite', 'Withdraw', 'Skull Bash'),
(9, 'Blastoise', 83, 85, 100, 105, 79, 78, 'Blastoise', 32, 'Water', NULL, 210, 9, 'Bite', 'Withdraw', 'Skull Bash', 'Hydro Pump'),
(10, 'Caterpie', 30, 20, 35, 20, 45, 45, 'Metapod', 7, 'Bug', NULL, 53, 10, 'Tackle', 'String Shot', 'String Shot', 'String Shot'),
(11, 'Metapod', 20, 25, 55, 25, 50, 30, 'Butterfree', 12, 'Bug', NULL, 72, 11, 'Tackle', 'Harden', 'String Shot', 'String Shot'),
(12, 'Butterfree', 45, 80, 50, 80, 60, 70, 'Butterfree', 12, 'Bug', 'Flying', 160, 12, 'Sleep Powder', 'Supersonic', 'Whirlwind', 'Psybeam'),
(13, 'Weedle', 35, 20, 30, 20, 40, 50, 'Kakuna', 7, 'Bug', 'Poison', 52, 13, 'Poison Sting', 'String Shot', 'String Shot', 'String Shot'),
(14, 'Kakuna', 25, 25, 50, 25, 45, 35, 'Beedrill', 12, 'Bug', 'Poison', 71, 14, 'Poison Sting', 'Harden', 'String Shot', 'String Shot'),
(15, 'Beedrill', 80, 45, 40, 80, 65, 75, 'Beedrill', 12, 'Bug', 'Poison', 159, 15, 'Twineedle', 'Rage', 'Pin Missile', 'Agility'),
(16, 'Pidgey', 45, 35, 40, 35, 40, 56, 'Pidgeotto', 18, 'Normal', 'Flying', 55, 16, 'Gust', 'Sand Attack', 'Quick Attack', 'Whirlwind'),
(17, 'Pidgeotto', 60, 50, 55, 50, 63, 71, 'Pidgeot', 36, 'Normal', 'Flying', 113, 17, 'Whirlwind', 'Wing Attack', 'Agility', 'Mirror Move'),
(18, 'Pidgeot', 80, 70, 75, 70, 83, 91, 'Pidgeot', 36, 'Normal', 'Flying', 172, 18, 'Whirlwind', 'Wing Attack', 'Agility', 'Mirror Move'),
(19, 'Rattata', 56, 25, 35, 35, 30, 72, 'Raticate', 20, 'Normal', NULL, 57, 19, 'Tackle', 'Tail Whip', 'Quick Attack', 'Hyper Fang'),
(20, 'Raticate', 81, 50, 60, 70, 55, 97, 'Raticate', 20, 'Normal', NULL, 116, 20, 'Quick Attack', 'Hyper Fang', 'Focus Energy', 'Super Fang'),
(21, 'Spearow', 60, 31, 30, 31, 40, 70, 'Fearow', 20, 'Normal', 'Flying', 58, 21, 'Peck', 'Growl', 'Leer', 'Fury Attack'),
(22, 'Fearow', 90, 61, 65, 61, 65, 100, 'Fearow', 20, 'Normal', 'Flying', 162, 22, 'Fury Attack', 'Mirror Move', 'Drill Peck', 'Agility'),
(23, 'Ekans', 60, 40, 44, 54, 35, 55, 'Arbok', 22, 'Poison', NULL, 62, 23, 'Wrap', 'Leer', 'Poison Sting', 'Bite'),
(24, 'Arbok', 85, 65, 69, 79, 60, 80, 'Arbok', 22, 'Poison', NULL, 147, 24, 'Bite', 'Glare', 'Screech', 'Acid'),
(25, 'Pikachu', 55, 50, 30, 40, 35, 90, 'Raichu', 45, 'Electric', NULL, 82, 25, 'Thundershock', 'Growl', 'Thunder Wave', 'Quick Attack'),
(26, 'Raichu', 90, 90, 55, 80, 60, 100, 'Raichu', 45, 'Electric', NULL, 122, 26, 'Quick Attack', 'Swift', 'Agility', 'Thunder'),
(27, 'Sandshrew', 75, 20, 85, 30, 50, 40, 'Sandslash', 22, 'Ground', NULL, 93, 27, 'Scratch', 'Sand Attack', 'Slash', 'Poison Sting'),
(28, 'Sandslash', 100, 45, 110, 55, 75, 65, 'Sandslash', 22, 'Ground', NULL, 163, 28, 'Slash', 'Poison Sting', 'Swift', 'Fury Swipes'),
(29, 'Nidoran (f)', 47, 40, 52, 40, 55, 41, 'Nidorina', 18, 'Poison', '', 59, 29, 'Absorb', 'Absorb', 'Absorb', 'Absorb'),
(30, 'Nidorina', 62, 55, 67, 55, 70, 56, 'Nidoqueen', 45, 'Poison', NULL, 117, 30, 'Tail Whip', 'Bite', 'Fury Swipes', 'Double Kick'),
(31, 'Nidoqueen', 82, 75, 87, 85, 90, 76, 'Nidoqueen', 45, 'Poison', 'Ground', 194, 31, 'Fury Swipes', 'Double Kick', 'Poison Sting', 'Body Slam'),
(32, 'Nidoran (m)', 57, 40, 40, 40, 46, 50, 'Nidorino', 18, 'Poison', '', 60, 32, 'Absorb', 'Absorb', 'Absorb', 'Absorb'),
(33, 'Nidorino', 72, 55, 57, 55, 61, 65, 'Nidoking', 45, 'Poison', NULL, 118, 33, 'Focus Energy', 'Fury Attack', 'Horn Drill', 'Double Kick'),
(34, 'Nidoking', 92, 85, 77, 75, 81, 85, 'Nidoking', 45, 'Poison', 'Ground', 195, 34, 'Fury Attack', 'Horn Drill', 'Double Kick', 'Thrash'),
(35, 'Clefairy', 45, 60, 48, 65, 70, 35, 'Clefable', 45, 'Normal', NULL, 68, 35, 'Pound', 'Growl', 'Sing', 'Doubleslap'),
(36, 'Clefable', 70, 85, 73, 90, 95, 60, 'Clefable', 45, 'Normal', NULL, 129, 36, 'Minimize', 'Metronome', 'Defense Curl', 'Light Screen'),
(37, 'Vulpix', 41, 50, 40, 65, 38, 65, 'Ninetales', 45, 'Fire', NULL, 63, 37, 'Ember', 'Tail Whip', 'Quick Attack', 'Roar'),
(38, 'Ninetales', 76, 81, 75, 100, 73, 100, 'Ninetales', 45, 'Fire', NULL, 178, 38, 'Roar', 'Confuse Ray', 'Flamethrower', 'Fire Spin'),
(39, 'Jigglypuff', 45, 45, 20, 25, 115, 20, 'Wigglytuff', 45, 'Normal', NULL, 76, 39, 'Sing', 'Pound', 'Disable', 'Defense Curl'),
(40, 'Wigglytuff', 70, 75, 45, 50, 140, 45, 'Wigglytuff', 45, 'Normal', NULL, 109, 40, 'Doubleslap', 'Rest', 'Body Slam', 'Double Edge'),
(41, 'Zubat', 45, 30, 35, 40, 40, 55, 'Golbat', 22, 'Poison', 'Flying', 54, 41, 'Leech Life', 'Supersonic', 'Bite', 'Confuse Ray'),
(42, 'Golbat', 80, 65, 70, 75, 75, 90, 'Golbat', 22, 'Poison', 'Flying', 171, 42, 'Bite', 'Confuse Ray', 'Wing Attack', 'Haze'),
(43, 'Oddish', 50, 75, 55, 65, 45, 30, 'Gloom', 26, 'Grass', 'Poison', 78, 43, 'Absorb', 'Poison Powder', 'Stun Spore', 'Sleep Powder'),
(44, 'Gloom', 65, 85, 70, 75, 60, 40, 'Vileplume', 45, 'Grass', 'Poison', 132, 44, 'Sleep Powder', 'Acid', 'Petal Dance', 'Solar Beam'),
(45, 'Vileplume', 80, 100, 85, 90, 75, 50, 'Vileplume', 45, 'Grass', 'Poison', 184, 45, 'Sleep Powder', 'Acid', 'Petal Dance', 'Solar Beam'),
(46, 'Paras', 70, 45, 55, 55, 35, 25, 'Parasect', 24, 'Bug', 'Grass', 70, 46, 'Scratch', 'Stun Spore', 'Leech Life', 'Spore'),
(47, 'Parasect', 95, 60, 80, 80, 60, 30, 'Parasect', 24, 'Bug', 'Grass', 128, 47, 'Leech Life', 'Spore', 'Slash', 'Growth'),
(48, 'Venonat', 55, 40, 50, 55, 60, 45, 'Venomoth', 31, 'Bug', 'Poison', 75, 48, 'Tackle', 'Disable', 'Poison Powder', 'Leech Life'),
(49, 'Venomoth', 65, 90, 60, 75, 70, 90, 'Venomoth', 31, 'Bug', 'Poison', 138, 49, 'Stun Spore', 'Psybeam', 'Sleep Powder', 'Psychic'),
(50, 'Diglett', 55, 35, 25, 45, 10, 95, 'Dugtrio', 29, 'Ground', NULL, 81, 50, 'Scratch', 'Growl', 'Dig', 'Sand Attack'),
(51, 'Dugtrio', 80, 50, 50, 70, 35, 120, 'Dugtrio', 29, 'Ground', NULL, 153, 51, 'Dig', 'Sand Attack', 'Slash', 'Earthquake'),
(52, 'Meowth', 45, 40, 35, 40, 40, 90, 'Persian', 28, 'Normal', NULL, 69, 52, 'Scratch', 'Growl', 'Bite', 'Pay Day'),
(53, 'Persian', 70, 65, 60, 65, 65, 115, 'Persian', 28, 'Normal', NULL, 148, 53, 'Pay Day', 'Screech', 'Fury Swipes', 'Slash'),
(54, 'Psyduck', 52, 65, 48, 50, 50, 55, 'Golduck', 33, 'Water', NULL, 80, 54, 'Scratch', 'Tail Whip', 'Disable', 'Confusion'),
(55, 'Golduck', 82, 95, 78, 80, 80, 85, 'Golduck', 33, 'Water', NULL, 174, 55, 'Disable', 'Confusion', 'Fury Swipes', 'Hydro Pump'),
(56, 'Mankey', 80, 35, 35, 45, 40, 70, 'Primeape', 28, 'Fighting', NULL, 74, 56, 'Scratch', 'Leer', 'Karate Chop', 'Fury Attack'),
(57, 'Primeape', 105, 60, 60, 70, 65, 95, 'Primeape', 28, 'Fighting', NULL, 149, 57, 'Fury Attack', 'Focus Energy', 'Seismic Toss', 'Thrash'),
(58, 'Growlithe', 70, 70, 45, 50, 55, 60, 'Arcanine', 45, 'Fire', NULL, 91, 58, 'Bite', 'Roar', 'Ember', 'Leer'),
(59, 'Arcanine', 110, 100, 80, 80, 90, 95, 'Arcanine', 45, 'Fire', NULL, 213, 59, 'Leer', 'Take Down', 'Agility', 'Flamethrower'),
(60, 'Poliwag', 50, 40, 40, 40, 40, 90, 'Poliwhirl', 25, 'Water', NULL, 77, 60, 'Bubble', 'Hypnosis', 'Water Gun', 'Doubleslap'),
(61, 'Poliwhirl', 65, 50, 65, 50, 65, 90, 'Poliwrath', 45, 'Water', NULL, 131, 61, 'Doubleslap', 'Body Slam', 'Amnesia', 'Hydro Pump'),
(62, 'Poliwrath', 85, 70, 95, 90, 90, 70, 'Poliwrath', 45, 'Water', 'Fighting', 185, 62, 'Doubleslap', 'Body Slam', 'Amnesia', 'Hydro Pump'),
(63, 'Abra', 20, 105, 15, 55, 25, 90, 'Kadabra', 18, 'Psychic', NULL, 75, 63, 'Teleport', 'Teleport', 'Teleport', 'Teleport'),
(64, 'Kadabra', 35, 120, 30, 70, 40, 105, 'Alakazam', 45, 'Psychic', NULL, 145, 64, 'Teleport', 'Confusion', 'Disable', 'Psybeam'),
(65, 'Alakazam', 50, 135, 45, 85, 55, 120, 'Alakazam', 45, 'Psychic', NULL, 186, 65, 'Psybeam', 'Recover', 'Psychic', 'Reflect'),
(66, 'Machop', 80, 35, 50, 35, 70, 35, 'Machoke', 18, 'Fighting', NULL, 75, 66, 'Karate Chop', 'Low Kick', 'Leer', 'Focus Energy'),
(67, 'Machoke', 100, 50, 70, 60, 80, 45, 'Machamp', 45, 'Fighting', NULL, 146, 67, 'Leer', 'Focus Energy', 'Seismic Toss', 'Submission'),
(68, 'Machamp', 130, 65, 80, 85, 90, 55, 'Machamp', 45, 'Fighting', NULL, 193, 68, 'Leer', 'Focus Energy', 'Seismic Toss', 'Submission'),
(69, 'Bellsprout', 75, 70, 35, 30, 50, 40, 'Weepinbell', 21, 'Grass', 'Poison', 84, 69, 'Vine Whip', 'Growth', 'Wrap', 'Poison Powder'),
(70, 'Weepinbell', 90, 85, 50, 45, 65, 55, 'Victreebel', 45, 'Grass', 'Poison', 151, 70, 'Stun Spore', 'Acid', 'Razor Leaf', 'Slam'),
(71, 'Victreebel', 105, 100, 65, 60, 80, 70, 'Victreebel', 45, 'Grass', 'Poison', 191, 71, 'Stun Spore', 'Acid', 'Razor Leaf', 'Slam'),
(72, 'Tentacool', 40, 50, 35, 100, 40, 70, 'Tentacruel', 30, 'Water', 'Poison', 105, 72, 'Acid', 'Supersonic', 'Wrap', 'Poison Sting'),
(73, 'Tentacruel', 70, 80, 65, 120, 80, 100, 'Tentacruel', 30, 'Water', 'Poison', 205, 73, 'Constrict', 'Barrier', 'Screech', 'Hydro Pump'),
(74, 'Geodude', 80, 30, 100, 30, 40, 20, 'Graveler', 25, 'Rock', 'Ground', 73, 74, 'Tackle', 'Defense Curl', 'Rock Throw', 'Self Destruct'),
(75, 'Graveler', 95, 45, 115, 45, 55, 35, 'Golem', 45, 'Rock', 'Ground', 134, 75, 'Self Destruct', 'Harden', 'Earthquake', 'Explosion'),
(76, 'Golem', 110, 55, 130, 65, 80, 45, 'Golem', 45, 'Rock', 'Ground', 177, 76, 'Self Destruct', 'Harden', 'Earthquake', 'Explosion'),
(77, 'Ponyta', 85, 65, 55, 65, 50, 90, 'Rapidash', 40, 'Fire', NULL, 152, 77, 'Ember', 'Tail Whip', 'Stomp', 'Growl'),
(78, 'Rapidash', 100, 80, 70, 80, 65, 105, 'Rapidash', 40, 'Fire', NULL, 192, 78, 'Growl', 'Fire Spin', 'Take Down', 'Agility'),
(79, 'Slowpoke', 65, 40, 65, 40, 90, 15, 'Slowbro', 37, 'Water', 'Psychic', 99, 79, 'Confusion', 'Disable', 'Head Butt', 'Growl'),
(80, 'Slowbro', 75, 100, 110, 80, 95, 30, 'Slowking', 45, 'Water', 'Psychic', 164, 80, 'Growl', 'Water Gun', 'Amnesia', 'Psychic'),
(81, 'Magnemite', 35, 95, 70, 55, 25, 45, 'Magneton', 30, 'Electric', 'Steel', 89, 81, 'Tackle', 'Sonic Boom', 'Thundershock', 'Supersonic'),
(82, 'Magneton', 60, 120, 95, 70, 50, 70, 'Magnezone', 45, 'Electric', 'Steel', 161, 82, 'Supersonic', 'Thunder Wave', 'Swift', 'Screech'),
(83, 'Farfetch''d', 65, 58, 55, 62, 52, 60, 'Farfetch''d', 1, 'Normal', 'Flying', 94, 83, 'Absorb', 'Absorb', 'Absorb', 'Absorb'),
(84, 'Doduo', 85, 35, 45, 35, 35, 75, 'Dodrio', 45, 'Normal', 'Flying', 96, 84, 'Peck', 'Growl', 'Fury Attack', 'Drill Peck'),
(85, 'Dodrio', 110, 60, 70, 60, 60, 100, 'Dodrio', 45, 'Normal', 'Flying', 158, 85, 'Drill Peck', 'Rage', 'Tri Attack', 'Agility'),
(86, 'Seel', 45, 45, 55, 70, 65, 45, 'Dewgong', 40, 'Water', NULL, 100, 86, 'Head Butt', 'Growl', 'Aurora Beam', 'Rest'),
(87, 'Dewgong', 70, 70, 80, 95, 90, 70, 'Dewgong', 40, 'Water', 'Ice', 176, 87, 'Aurora Beam', 'Rest', 'Take Down', 'Ice Beam'),
(88, 'Grimer', 80, 40, 50, 50, 80, 25, 'Muk', 35, 'Poison', NULL, 90, 88, 'Pound', 'Disable', 'Poison Gas', 'Minimize'),
(89, 'Muk', 105, 65, 75, 100, 105, 50, 'Muk', 35, 'Poison', NULL, 157, 89, 'Sludge', 'Harden', 'Screech', 'Acid Armor'),
(90, 'Shellder', 65, 45, 100, 25, 30, 40, 'Cloyster', 45, 'Water', NULL, 97, 90, 'Tackle', 'Withdraw', 'Supersonic', 'Clamp'),
(91, 'Cloyster', 95, 85, 180, 45, 50, 70, 'Cloyster', 45, 'Water', 'Ice', 203, 91, 'Aurora Beam', 'Leer', 'Ice Beam', 'Spike Cannon'),
(92, 'Gastly', 35, 100, 30, 35, 30, 80, 'Haunter', 25, 'Ghost', 'Poison', 95, 92, 'Lick', 'Confuse Ray', 'Night Shade', 'Hypnosis'),
(93, 'Haunter', 50, 115, 45, 55, 45, 95, 'Gengar', 45, 'Ghost', 'Poison', 126, 93, 'Confuse Ray', 'Night Shade', 'Hypnosis', 'Dream Eater'),
(94, 'Gengar', 65, 130, 60, 75, 60, 110, 'Gengar', 45, 'Ghost', 'Poison', 190, 94, 'Confuse Ray', 'Night Shade', 'Hypnosis', 'Dream Eater'),
(95, 'Onix', 45, 30, 160, 45, 35, 70, 'Steelix', 45, 'Rock', 'Ground', 108, 95, 'Rock Throw', 'Rage', 'Slam', 'Harden'),
(96, 'Drowzee', 48, 43, 45, 90, 60, 42, 'Hypno', 26, 'Psychic', NULL, 102, 96, 'Pound', 'Hypnosis', 'Disable', 'Confusion'),
(97, 'Hypno', 73, 73, 70, 115, 85, 67, 'Hypno', 26, 'Psychic', NULL, 165, 97, 'Head Butt', 'Poison Gas', 'Psychic', 'Meditate'),
(98, 'Krabby', 105, 25, 90, 25, 30, 50, 'Kingler', 21, 'Water', NULL, 115, 98, 'Bubble', 'Leer', 'Vice Grip', 'Guillotine'),
(99, 'Kingler', 130, 50, 115, 50, 55, 75, 'Kingler', 21, 'Water', NULL, 206, 99, 'Guillotine', 'Stomp', 'Crab Hammer', 'Harden'),
(100, 'Voltorb', 30, 55, 50, 55, 40, 100, 'Electrode', 30, 'Electric', NULL, 103, 100, 'Tackle', 'Screech', 'Sonic Boom', 'Self Destruct'),
(101, 'Electrode', 50, 80, 70, 80, 60, 140, 'Electrode', 30, 'Electric', NULL, 150, 101, 'Self Destruct', 'Light Screen', 'Swift', 'Explosion'),
(102, 'Exeggcute', 40, 60, 80, 45, 60, 40, NULL, NULL, 'Grass', 'Psychic', 98, 102, 'Barrage', 'Hypnosis', 'Reflect', 'Leech Seed'),
(103, 'Exeggutor', 95, 125, 85, 65, 95, 55, NULL, NULL, 'Grass', 'Psychic', 212, 103, 'Poison Powder', 'Solar Beam', 'Sleep Powder', 'Stomp'),
(104, 'Cubone', 50, 40, 95, 50, 50, 35, NULL, NULL, 'Ground', NULL, 87, 104, 'Bone Club', 'Growl', 'Leer', 'Focus Energy'),
(105, 'Marowak', 80, 50, 110, 80, 60, 45, NULL, NULL, 'Ground', NULL, 124, 105, 'Focus Energy', 'Thrash', 'Bonemerang', 'Rage'),
(106, 'Hitmonlee', 120, 35, 53, 110, 50, 87, NULL, NULL, 'Fighting', NULL, 139, 106, 'Jump Kick', 'Focus Energy', 'Hi Jump Kick', 'Mega Kick'),
(107, 'Hitmonchan', 105, 35, 79, 110, 50, 76, NULL, NULL, 'Fighting', NULL, 140, 107, 'Ice Punch', 'Thunder Punch', 'Mega Punch', 'Counter'),
(108, 'Lickitung', 55, 60, 75, 75, 90, 30, NULL, NULL, 'Normal', NULL, 127, 108, 'Disable', 'Defense Curl', 'Slam', 'Screech'),
(109, 'Koffing', 65, 60, 95, 45, 40, 35, NULL, NULL, 'Poison', NULL, 114, 109, 'Tackle', 'Smog', 'Sludge', 'Smoke Screen'),
(110, 'Weezing', 90, 85, 120, 70, 65, 60, NULL, NULL, 'Poison', NULL, 173, 110, 'Smoke Screen', 'Self Destruct', 'Haze', 'Explosion'),
(111, 'Rhyhorn', 85, 30, 95, 30, 80, 25, NULL, NULL, 'Ground', 'Rock', 135, 111, 'Horn Attack', 'Stomp', 'Tail Whip', 'Fury Attack'),
(112, 'Rhydon', 130, 45, 120, 45, 105, 40, NULL, NULL, 'Ground', 'Rock', 204, 112, 'Fury Attack', 'Horn Drill', 'Leer', 'Take Down'),
(113, 'Chansey', 5, 35, 5, 105, 250, 50, NULL, NULL, 'Normal', NULL, 255, 113, 'Splash', 'Splash', 'Splash', 'Splash'),
(114, 'Tangela', 55, 100, 115, 40, 65, 60, NULL, NULL, 'Grass', NULL, 166, 114, 'Stun Spore', 'Sleep Powder', 'Slam', 'Growth'),
(115, 'Kangaskhan', 95, 40, 80, 80, 105, 90, NULL, NULL, 'Normal', NULL, 175, 115, 'Tail Whip', 'Mega Punch', 'Leer', 'Dizzy Punch'),
(116, 'Horsea', 40, 70, 70, 25, 30, 60, NULL, NULL, 'Water', NULL, 83, 116, 'Bubble', 'Smoke Screen', 'Leer', 'Water Gun'),
(117, 'Seadra', 65, 95, 95, 45, 55, 85, NULL, NULL, 'Water', NULL, 155, 117, 'Leer', 'Water Gun', 'Agility', 'Hydro Pump'),
(118, 'Goldeen', 67, 35, 60, 50, 45, 63, NULL, NULL, 'Water', NULL, 111, 118, 'Peck', 'Tail Whip', 'Supersonic', 'Horn Attack'),
(119, 'Seaking', 92, 65, 65, 80, 80, 68, NULL, NULL, 'Water', NULL, 170, 119, 'Fury Attack', 'Waterfall', 'Horn Drill', 'Agility'),
(120, 'Staryu', 45, 70, 55, 55, 30, 85, NULL, NULL, 'Water', NULL, 106, 120, 'Tackle', 'Water Gun', 'Harden', 'Recover'),
(121, 'Starmie', 75, 100, 85, 85, 60, 115, NULL, NULL, 'Water', 'Psychic', 207, 121, 'Swift', 'Minimize', 'Light Screen', 'Hydro Pump'),
(122, 'Mr. Mime', 45, 100, 65, 120, 40, 90, NULL, NULL, 'Psychic', NULL, 136, 122, 'Light Screen', 'Doubleslap', 'Meditate', 'Substitute'),
(123, 'Scyther', 110, 55, 80, 80, 70, 105, NULL, NULL, 'Bug', 'Flying', 187, 123, 'Double Team', 'Slash', 'Swords Dance', 'Agility'),
(124, 'Jynx', 50, 115, 35, 95, 65, 95, NULL, NULL, 'Ice', 'Psychic', 137, 124, 'Doubleslap', 'Ice Punch', 'Meditate', 'Blizzard'),
(125, 'Electabuzz', 83, 95, 57, 85, 65, 105, NULL, NULL, 'Electric', NULL, 156, 125, 'Screech', 'Thunder Punch', 'Light Screen', 'Thunder'),
(126, 'Magmar', 95, 100, 57, 85, 65, 93, NULL, NULL, 'Fire', NULL, 167, 126, 'Fire Punch', 'Smoke Screen', 'Smog', 'Flamethrower'),
(127, 'Pinsir', 125, 55, 100, 70, 65, 85, NULL, NULL, 'Bug', NULL, 200, 127, 'Focus Energy', 'Harden', 'Slash', 'Swords Dance'),
(128, 'Tauros', 100, 40, 95, 70, 75, 110, NULL, NULL, 'Normal', NULL, 211, 128, 'Tail Whip', 'Leer', 'Rage', 'Take Down'),
(129, 'Magikarp', 10, 15, 55, 20, 20, 80, 'Gyarados', 20, 'Water', NULL, 20, 129, 'Tackle', 'Splash', 'Splash', 'Splash'),
(130, 'Gyarados', 125, 60, 79, 100, 95, 81, NULL, NULL, 'Water', 'Flying', 214, 130, 'Dragon Rage', 'Leer', 'Hydro Pump', 'Hyper Beam'),
(131, 'Lapras', 85, 85, 80, 95, 130, 60, NULL, NULL, 'Water', 'Ice', 219, 131, 'Body Slam', 'Confuse Ray', 'Ice Beam', 'Hydro Pump'),
(132, 'Ditto', 48, 48, 48, 48, 48, 48, NULL, NULL, 'Normal', NULL, 61, 132, 'Transform', 'Transform', 'Transform', 'Transform'),
(133, 'Eevee', 55, 45, 50, 65, 55, 55, NULL, NULL, 'Normal', NULL, 92, 133, 'Quick Attack', 'Tail Whip', 'Bite', 'Take Down'),
(134, 'Vaporeon', 65, 110, 60, 95, 130, 65, NULL, NULL, 'Water', NULL, 196, 134, 'Acid Armor', 'Haze', 'Mist', 'Hydro Pump'),
(135, 'Jolteon', 65, 110, 60, 95, 65, 130, NULL, NULL, 'Electric', NULL, 197, 135, 'Double Kick', 'Agility', 'Pin Missile', 'Thunder'),
(136, 'Flareon', 130, 95, 60, 110, 65, 65, NULL, NULL, 'Fire', NULL, 198, 136, 'Leer', 'Fire Spin', 'Rage', 'Flamethrower'),
(137, 'Porygon', 60, 85, 70, 75, 65, 40, NULL, NULL, 'Normal', NULL, 130, 137, 'Psybeam', 'Recover', 'Agility', 'Tri Attack'),
(138, 'Omanyte', 40, 90, 100, 55, 35, 35, NULL, NULL, 'Rock', 'Water', 99, 138, 'Water Gun', 'Withdraw', 'Horn Attack', 'Leer'),
(139, 'Omastar', 60, 115, 125, 70, 70, 55, NULL, NULL, 'Rock', 'Water', 199, 139, 'Horn Attack', 'Leer', 'Spike Cannon', 'Hydro Pump'),
(140, 'Kabuto', 80, 55, 90, 45, 30, 55, NULL, NULL, 'Rock', 'Water', 99, 140, 'Scratch', 'Harden', 'Absorb', 'Slash'),
(141, 'Kabutops', 115, 65, 105, 70, 60, 80, NULL, NULL, 'Rock', 'Water', 199, 141, 'Absorb', 'Slash', 'Leer', 'Hydro Pump'),
(142, 'Aerodactyl', 105, 60, 65, 75, 80, 130, NULL, NULL, 'Rock', 'Flying', 202, 142, 'Supersonic', 'Bite', 'Take Down', 'Hyper Beam'),
(143, 'Snorlax', 110, 65, 65, 110, 160, 30, NULL, NULL, 'Normal', NULL, 154, 143, 'Body Slam', 'Harden', 'Double Edge', 'Hyper Beam'),
(144, 'Articuno', 85, 95, 100, 125, 90, 85, NULL, NULL, 'Ice', 'Flying', 215, 144, 'Ice Beam', 'Blizzard', 'Agility', 'Mist'),
(145, 'Zapdos', 90, 125, 85, 90, 90, 100, NULL, NULL, 'Electric', 'Flying', 216, 145, 'Drill Peck', 'Thunder', 'Agility', 'Light Screen'),
(146, 'Moltres', 100, 125, 90, 85, 90, 90, 'NULL', 0, 'Fire', 'Flying', 217, 146, 'Fire Spin', 'Leer', 'Agility', 'Sky Attack'),
(147, 'Dratini', 64, 50, 45, 50, 41, 50, NULL, NULL, 'Dragon', NULL, 67, 147, 'Wrap', 'Leer', 'Thunder Wave', 'Agility'),
(148, 'Dragonair', 84, 70, 65, 70, 61, 70, NULL, NULL, 'Dragon', NULL, 144, 148, 'Agility', 'Slam', 'Dragon Rage', 'Hyper Beam'),
(149, 'Dragonite', 134, 100, 95, 100, 91, 80, NULL, NULL, 'Dragon', 'Flying', 218, 149, 'Agility', 'Slam', 'Dragon Rage', 'Hyper Beam'),
(150, 'Mewtwo', 110, 154, 90, 90, 106, 130, NULL, NULL, 'Psychic', NULL, 220, 150, 'Psychic', 'Recover', 'Mist', 'Amnesia'),
(151, 'Mew', 100, 100, 100, 100, 100, 100, NULL, NULL, 'Psychic', NULL, 64, 151, 'Transform', 'Mega Punch', 'Metronome', 'Psychic'),
(152, 'Chikorita', 49, 49, 65, 65, 45, 45, NULL, NULL, 'Grass', NULL, 64, 152, 'Scratch', 'Growl', 'Absorb', 'Tackle'),
(153, 'Bayleef', 62, 63, 80, 80, 60, 60, NULL, NULL, 'Grass', NULL, 141, 153, 'Razor Leaf', 'Mega Drain', 'Body Slam', 'Tackle'),
(154, 'Meganium', 82, 83, 100, 100, 80, 80, NULL, NULL, 'Grass', NULL, 208, 154, 'Petal Dance', 'Razor Leaf', 'Razor Leaf', 'Solar Beam'),
(155, 'Cyndaquil', 52, 60, 43, 50, 39, 65, NULL, NULL, 'Fire', NULL, 65, 155, 'Fire Spin', 'Ember', 'Flamethrower', 'Fire Blast'),
(156, 'Quilava', 64, 80, 58, 65, 58, 80, NULL, NULL, 'Fire', NULL, 142, 156, 'Fire Spin', 'Ember', 'Fire Spin', 'Flamethrower'),
(157, 'Typhlosion', 84, 109, 78, 85, 78, 100, NULL, NULL, 'Fire', NULL, 209, 157, 'Flamethrower', 'Fire Blast', 'Fire Punch', 'Fire Blast'),
(158, 'Totodile', 65, 44, 64, 48, 50, 43, NULL, NULL, 'Water', NULL, 66, 158, 'Surf', 'Surf', 'Hydro Pump', 'Bubblebeam'),
(159, 'Croconaw', 80, 59, 80, 63, 65, 58, NULL, NULL, 'Water', NULL, 143, 159, 'Waterfall', 'Bubble', 'Clamp', 'Water Gun'),
(160, 'Feraligatr', 105, 79, 100, 83, 85, 78, NULL, NULL, 'Water', NULL, 210, 160, 'Crab Hammer', 'Crab Hammer', 'Hydro Pump', 'Crab Hammer'),
(161, 'Sentret', 46, 35, 34, 45, 35, 20, NULL, NULL, 'Normal', NULL, 57, 161, 'Horn Attack', 'Pay Day', 'Struggle', 'Tackle'),
(162, 'Furret', 76, 45, 64, 55, 85, 90, NULL, NULL, 'Normal', NULL, 116, 162, 'Quick Attack', 'Tri Attack', 'Comet Punch', 'Head Butt'),
(163, 'Hoothoot', 30, 36, 30, 56, 60, 50, NULL, NULL, 'Normal', 'Flying', 58, 163, 'Slam', 'Comet Punch', 'Gust', 'Peck'),
(164, 'Noctowl', 50, 76, 50, 96, 100, 70, NULL, NULL, 'Normal', 'Flying', 162, 164, 'Stomp', 'Hyper Fang', 'Gust', 'Sky Attack'),
(165, 'Ledyba', 20, 40, 30, 80, 40, 55, NULL, NULL, 'Bug', 'Flying', 54, 165, 'Pin Missile', 'Twineedle', 'Fly', 'Wing Attack'),
(166, 'Ledian', 35, 55, 50, 110, 55, 85, NULL, NULL, 'Bug', 'Flying', 134, 166, 'Pin Missile', 'Twineedle', 'Peck', 'Wing Attack'),
(167, 'Spinarak', 60, 40, 40, 40, 40, 30, NULL, NULL, 'Bug', 'Poison', 54, 167, 'Leech Life', 'Pin Missile', 'Smog', 'Acid'),
(168, 'Ariados', 90, 60, 70, 60, 70, 40, NULL, NULL, 'Bug', 'Poison', 134, 168, 'Leech Life', 'Twineedle', 'Smog', 'Smog'),
(169, 'Crobat', 90, 70, 80, 80, 85, 130, NULL, NULL, 'Poison', 'Flying', 204, 169, 'Sludge', 'Sludge', 'Peck', 'Gust'),
(170, 'Chinchou', 38, 56, 38, 56, 75, 67, NULL, NULL, 'Water', 'Electric', 90, 170, 'Surf', 'Bubblebeam', 'Thundershock', 'Thunderbolt'),
(171, 'Lanturn', 58, 76, 58, 76, 125, 67, NULL, NULL, 'Water', 'Electric', 156, 171, 'Hydro Pump', 'Hydro Pump', 'Thunder', 'Thunderbolt'),
(172, 'Pichu', 40, 35, 15, 35, 20, 60, NULL, NULL, 'Electric', NULL, 42, 172, 'Thunderbolt', 'Thunder Punch', 'Thunderbolt', 'Thunder'),
(173, 'Cleffa', 25, 45, 28, 55, 50, 15, NULL, NULL, 'Normal', NULL, 37, 173, 'Doubleslap', 'Razor Wind', 'Horn Attack', 'Pound'),
(174, 'Igglybuff', 30, 40, 15, 20, 90, 15, NULL, NULL, 'Normal', NULL, 39, 174, 'Doubleslap', 'Strength', 'Egg Bomb', 'Take Down'),
(175, 'Togepi', 20, 40, 65, 65, 35, 20, NULL, NULL, 'Normal', NULL, 74, 175, 'Hyper Fang', 'Strength', 'Strength', 'Fury Attack'),
(176, 'Togetic', 40, 80, 85, 105, 55, 40, NULL, NULL, 'Normal', 'Flying', 114, 176, 'Wrap', 'Dizzy Punch', 'Wing Attack', 'Wing Attack'),
(177, 'Natu', 50, 70, 45, 45, 40, 70, NULL, NULL, 'Psychic', 'Flying', 73, 177, 'Confusion', 'Psybeam', 'Wing Attack', 'Drill Peck'),
(178, 'Xatu', 75, 95, 70, 70, 65, 95, NULL, NULL, 'Psychic', 'Flying', 171, 178, 'Psychic', 'Dream Eater', 'Wing Attack', 'Drill Peck'),
(179, 'Mareep', 40, 65, 40, 45, 55, 35, NULL, NULL, 'Electric', NULL, 59, 179, 'Thunder Punch', 'Thunderbolt', 'Thundershock', 'Thunder'),
(180, 'Flaaffy', 55, 80, 55, 60, 70, 45, NULL, NULL, 'Electric', NULL, 117, 180, 'Thundershock', 'Thunder', 'Thunder Punch', 'Thunder'),
(181, 'Ampharos', 75, 115, 75, 90, 90, 55, NULL, NULL, 'Electric', NULL, 194, 181, 'Thundershock', 'Thundershock', 'Thundershock', 'Thunder'),
(182, 'Bellossom', 80, 90, 85, 100, 75, 50, NULL, NULL, 'Grass', NULL, 184, 182, 'Absorb', 'Mega Drain', 'Mega Drain', 'Razor Leaf'),
(183, 'Marill', 20, 20, 50, 50, 70, 40, NULL, NULL, 'Water', NULL, 58, 183, 'Bubblebeam', 'Bubble', 'Bubble', 'Clamp'),
(184, 'Azumarill', 50, 50, 80, 80, 100, 50, NULL, NULL, 'Water', NULL, 153, 184, 'Crab Hammer', 'Clamp', 'Crab Hammer', 'Crab Hammer'),
(185, 'Sudowoodo', 100, 30, 115, 65, 70, 30, NULL, NULL, 'Rock', NULL, 135, 185, 'Rock Slide', 'Rock Slide', 'Rock Slide', 'Rock Throw'),
(186, 'Politoed', 75, 90, 75, 100, 90, 70, NULL, NULL, 'Water', NULL, 185, 186, 'Bubblebeam', 'Water Gun', 'Crab Hammer', 'Water Gun'),
(187, 'Hoppip', 35, 35, 40, 55, 35, 50, NULL, NULL, 'Grass', 'Flying', 74, 187, 'Petal Dance', 'Vine Whip', 'Peck', 'Peck'),
(188, 'Skiploom', 45, 45, 50, 65, 55, 80, NULL, NULL, 'Grass', 'Flying', 136, 188, 'Solar Beam', 'Razor Leaf', 'Drill Peck', 'Fly'),
(189, 'Jumpluff', 55, 55, 70, 85, 75, 110, NULL, NULL, 'Grass', 'Flying', 176, 189, 'Mega Drain', 'Razor Leaf', 'Fly', 'Fly'),
(190, 'Aipom', 70, 40, 55, 55, 55, 85, NULL, NULL, 'Normal', NULL, 94, 190, 'Scratch', 'Self Destruct', 'Head Butt', 'Comet Punch'),
(191, 'Sunkern', 30, 30, 30, 30, 30, 30, NULL, NULL, 'Grass', NULL, 52, 191, 'Razor Leaf', 'Razor Leaf', 'Petal Dance', 'Solar Beam'),
(192, 'Sunflora', 75, 105, 55, 85, 75, 30, NULL, NULL, 'Grass', NULL, 146, 192, 'Vine Whip', 'Mega Drain', 'Razor Leaf', 'Petal Dance'),
(193, 'Yanma', 65, 75, 45, 45, 65, 95, NULL, NULL, 'Bug', 'Flying', 147, 193, 'Twineedle', 'Pin Missile', 'Peck', 'Sky Attack'),
(194, 'Wooper', 45, 25, 45, 25, 55, 15, NULL, NULL, 'Water', 'Ground', 52, 194, 'Water Gun', 'Water Gun', 'Earthquake', 'Bone Club'),
(195, 'Quagsire', 85, 65, 85, 65, 95, 35, NULL, NULL, 'Water', 'Ground', 137, 195, 'Waterfall', 'Waterfall', 'Dig', 'Bone Club'),
(196, 'Espeon', 65, 130, 60, 95, 65, 110, NULL, NULL, 'Psychic', NULL, 197, 196, 'Psychic', 'Psybeam', 'Psybeam', 'Confusion'),
(197, 'Umbreon', 65, 60, 110, 130, 95, 65, NULL, NULL, 'Dark', NULL, 197, 197, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(198, 'Murkrow', 85, 85, 42, 42, 60, 91, NULL, NULL, 'Dark', 'Flying', 107, 198, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(199, 'Slowking', 75, 100, 80, 110, 95, 30, NULL, NULL, 'Water', 'Psychic', 164, 199, 'Hydro Pump', 'Bubblebeam', 'Psychic', 'Psychic'),
(200, 'Misdreavus', 60, 85, 60, 85, 60, 85, NULL, NULL, 'Ghost', NULL, 147, 200, 'Shadow Armlet', 'Lick', 'Lick', 'Shadow Armlet'),
(202, 'Wobbuffet', 33, 33, 58, 58, 190, 33, NULL, NULL, 'Psychic', NULL, 177, 202, 'Psybeam', 'Psychic', 'Confusion', 'Dream Eater'),
(203, 'Girafarig', 80, 90, 65, 65, 70, 85, NULL, NULL, 'Normal', 'Psychic', 149, 203, 'Hyper Fang', 'Mega Punch', 'Confusion', 'Psybeam'),
(204, 'Pineco', 65, 35, 90, 35, 50, 15, NULL, NULL, 'Bug', NULL, 60, 204, 'Leech Life', 'Leech Life', 'Twineedle', 'Leech Life'),
(205, 'Forretress', 90, 60, 140, 60, 75, 40, NULL, NULL, 'Bug', 'Steel', 118, 205, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(206, 'Dunsparce', 70, 65, 70, 65, 100, 45, NULL, NULL, 'Normal', NULL, 125, 206, 'Razor Wind', 'Bite', 'Constrict', 'Wrap'),
(207, 'Gligar', 75, 35, 105, 65, 65, 85, NULL, NULL, 'Ground', 'Flying', 108, 207, 'Earthquake', 'Dig', 'Drill Peck', 'Drill Peck'),
(208, 'Steelix', 85, 55, 200, 65, 75, 30, NULL, NULL, 'Steel', 'Ground', 196, 208, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(209, 'Snubbull', 80, 40, 50, 40, 60, 30, NULL, NULL, 'Normal', NULL, 63, 209, 'Body Slam', 'Thrash', 'Head Butt', 'Skull Bash'),
(210, 'Granbull', 120, 60, 75, 60, 90, 45, NULL, NULL, 'Normal', NULL, 178, 210, 'Rage', 'Tackle', 'Swift', 'Pound'),
(211, 'Qwilfish', 95, 55, 75, 55, 65, 85, NULL, NULL, 'Water', 'Poison', 100, 211, 'Surf', 'Clamp', 'Poison Sting', 'Smog'),
(212, 'Scizor', 130, 55, 100, 80, 70, 65, NULL, NULL, 'Bug', 'Steel', 200, 212, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(213, 'Shuckle', 10, 10, 230, 230, 20, 5, NULL, NULL, 'Bug', 'Rock', 80, 213, 'Pin Missile', 'Pin Missile', 'Rock Throw', 'Rock Slide'),
(214, 'Heracross', 125, 40, 75, 95, 80, 85, NULL, NULL, 'Bug', 'Fighting', 200, 214, 'Twineedle', 'Twineedle', 'Karate Chop', 'Submission'),
(215, 'Sneasel', 95, 35, 55, 75, 55, 115, NULL, NULL, 'Dark', 'Ice', 132, 215, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(216, 'Teddiursa', 80, 50, 50, 50, 60, 40, NULL, NULL, 'Normal', NULL, 124, 216, 'Barrage', 'Doubleslap', 'Vice Grip', 'Pay Day'),
(217, 'Ursaring', 130, 75, 75, 75, 90, 55, NULL, NULL, 'Normal', NULL, 189, 217, 'Take Down', 'Tackle', 'Thrash', 'Rage'),
(218, 'Slugma', 40, 70, 40, 40, 40, 20, NULL, NULL, 'Fire', NULL, 78, 218, 'Ember', 'Fire Spin', 'Fire Spin', 'Flamethrower'),
(219, 'Magcargo', 50, 80, 120, 80, 50, 30, NULL, NULL, 'Fire', 'Rock', 154, 219, 'Ember', 'Ember', 'Rock Slide', 'Rock Throw'),
(220, 'Swinub', 50, 30, 40, 30, 50, 50, NULL, NULL, 'Ice', 'Ground', 78, 220, 'Ice Punch', 'Ice Beam', 'Dig', 'Bone Club'),
(221, 'Piloswine', 100, 60, 80, 60, 100, 50, NULL, NULL, 'Ice', 'Ground', 160, 221, 'Blizzard', 'Aurora Beam', 'Dig', 'Bone Club'),
(222, 'Corsola', 55, 65, 85, 85, 55, 35, NULL, NULL, 'Water', 'Rock', 113, 222, 'Bubble', 'Bubblebeam', 'Rock Slide', 'Rock Slide'),
(223, 'Remoraid', 65, 65, 35, 35, 35, 65, NULL, NULL, 'Water', NULL, 78, 223, 'Water Gun', 'Bubblebeam', 'Water Gun', 'Bubblebeam'),
(224, 'Octillery', 105, 105, 75, 75, 75, 45, NULL, NULL, 'Water', NULL, 164, 224, 'Hydro Pump', 'Hydro Pump', 'Water Gun', 'Surf'),
(225, 'Delibird', 55, 65, 45, 45, 45, 75, NULL, NULL, 'Ice', 'Flying', 183, 225, 'Blizzard', 'Ice Punch', 'Gust', 'Wing Attack'),
(226, 'Mantine', 40, 80, 70, 140, 65, 70, NULL, NULL, 'Water', 'Flying', 168, 226, 'Bubble', 'Bubble', 'Peck', 'Wing Attack'),
(227, 'Skarmory', 80, 40, 140, 70, 65, 70, NULL, NULL, 'Steel', 'Flying', 168, 227, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(228, 'Houndour', 60, 80, 30, 50, 45, 65, NULL, NULL, 'Dark', 'Fire', 114, 228, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(229, 'Houndoom', 90, 110, 50, 80, 75, 95, NULL, NULL, 'Dark', 'Fire', 204, 229, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(230, 'Kingdra', 95, 95, 95, 95, 75, 85, NULL, NULL, 'Water', 'Dragon', 207, 230, 'Waterfall', 'Surf', 'Dragon Rage', 'Dragon Rage'),
(231, 'Phanpy', 60, 40, 60, 40, 90, 40, NULL, NULL, 'Ground', NULL, 124, 231, 'Earthquake', 'Bone Club', 'Bonemerang', 'Earthquake'),
(232, 'Donphan', 120, 60, 120, 60, 90, 50, NULL, NULL, 'Ground', NULL, 189, 232, 'Earthquake', 'Earthquake', 'Bone Club', 'Bone Club'),
(233, 'Porygon2', 80, 105, 90, 95, 85, 60, NULL, NULL, 'Normal', NULL, 180, 233, 'Mega Punch', 'Bind', 'Hyper Fang', 'Fury Swipes'),
(234, 'Stantler', 95, 85, 62, 65, 73, 85, NULL, NULL, 'Normal', NULL, 165, 234, 'Head Butt', 'Mega Punch', 'Slash', 'Tri Attack'),
(235, 'Smeargle', 20, 20, 35, 45, 55, 75, NULL, NULL, 'Normal', NULL, 106, 235, 'Doubleslap', 'Stomp', 'Strength', 'Doubleslap'),
(236, 'Tyrogue', 35, 35, 35, 35, 35, 35, NULL, NULL, 'Fighting', NULL, 91, 236, 'Karate Chop', 'Rolling Kick', 'Karate Chop', 'Rolling Kick'),
(237, 'Hitmontop', 95, 35, 95, 110, 50, 70, NULL, NULL, 'Fighting', NULL, 138, 237, 'Karate Chop', 'Jump Kick', 'Double Kick', 'Double Kick'),
(238, 'Smoochum', 30, 85, 15, 65, 45, 65, NULL, NULL, 'Ice', 'Psychic', 87, 238, 'Ice Punch', 'Ice Punch', 'Dream Eater', 'Psybeam'),
(239, 'Elekid', 63, 65, 37, 55, 45, 95, NULL, NULL, 'Electric', NULL, 106, 239, 'Thundershock', 'Thunder', 'Thunderbolt', 'Thunder Punch'),
(240, 'Magby', 75, 70, 37, 55, 45, 83, NULL, NULL, 'Fire', NULL, 117, 240, 'Flamethrower', 'Fire Blast', 'Fire Spin', 'Fire Punch'),
(241, 'Miltank', 80, 40, 105, 70, 95, 100, NULL, NULL, 'Normal', NULL, 200, 241, 'Slash', 'Comet Punch', 'Strength', 'Double Edge'),
(242, 'Blissey', 120, 120, 150, 135, 255, 55, NULL, NULL, 'Normal', NULL, 255, 242, 'Blizzard', 'Splash', 'Splash', 'Splash'),
(243, 'Raikou', 85, 115, 75, 100, 90, 115, NULL, NULL, 'Electric', NULL, 216, 243, 'Thunder', 'Thunderbolt', 'Thundershock', 'Thunder Punch'),
(244, 'Entei', 115, 90, 85, 75, 115, 100, NULL, NULL, 'Fire', NULL, 217, 244, 'Fire Spin', 'Flamethrower', 'Ember', 'Fire Punch'),
(245, 'Suicune', 75, 90, 115, 115, 100, 85, NULL, NULL, 'Water', NULL, 215, 245, 'Surf', 'Waterfall', 'Water Gun', 'Bubble'),
(246, 'Larvitar', 64, 45, 50, 50, 50, 41, 'Pupitar', 30, 'Rock', 'Ground', 67, 246, 'Rock Throw', 'Rock Throw', 'Dig', 'Bone Club'),
(247, 'Pupitar', 84, 65, 70, 70, 70, 51, 'Tyranitar', 55, 'Rock', 'Ground', 144, 247, 'Rock Slide', 'Rock Throw', 'Dig', 'Bone Club'),
(248, 'Tyranitar', 134, 95, 110, 100, 100, 61, NULL, NULL, 'Rock', 'Dark', 218, 248, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(249, 'Lugia', 90, 90, 130, 154, 106, 110, NULL, NULL, 'Psychic', 'Flying', 220, 249, 'Dream Eater', 'Psychic', 'Drill Peck', 'Drill Peck'),
(250, 'Ho-oh', 130, 110, 90, 154, 106, 90, NULL, NULL, 'Fire', 'Flying', 220, 250, 'Ember', 'Fire Blast', 'Drill Peck', 'Sky Attack'),
(251, 'Celebi', 100, 100, 100, 100, 100, 100, NULL, NULL, 'Psychic', 'Grass', 64, 251, 'Psybeam', 'Psybeam', 'Solar Beam', 'Razor Leaf'),
(252, 'Treecko', 45, 65, 35, 55, 40, 70, NULL, NULL, 'Grass', NULL, 65, 252, 'Solar Beam', 'Petal Dance', 'Petal Dance', 'Mega Drain'),
(253, 'Grovyle', 65, 85, 45, 65, 50, 95, NULL, NULL, 'Grass', NULL, 141, 253, 'Solar Beam', 'Razor Leaf', 'Razor Leaf', 'Vine Whip'),
(254, 'Sceptile', 85, 105, 65, 85, 70, 120, NULL, NULL, 'Grass', NULL, 208, 254, 'Solar Beam', 'Razor Leaf', 'Solar Beam', 'Absorb'),
(255, 'Torchic', 60, 70, 40, 50, 45, 45, NULL, NULL, 'Fire', NULL, 65, 255, 'Fire Spin', 'Fire Blast', 'Fire Punch', 'Fire Spin'),
(256, 'Combusken', 85, 85, 60, 60, 60, 55, NULL, NULL, 'Fire', 'Fighting', 142, 256, 'Fire Punch', 'Fire Punch', 'Submission', 'Rolling Kick'),
(257, 'Blaziken', 120, 110, 70, 70, 80, 80, NULL, NULL, 'Fire', 'Fighting', 209, 257, 'Fire Spin', 'Fire Punch', 'Karate Chop', 'Submission'),
(258, 'Mudkip', 70, 50, 50, 50, 50, 40, NULL, NULL, 'Water', NULL, 65, 258, 'Bubblebeam', 'Bubblebeam', 'Hydro Pump', 'Hydro Pump'),
(259, 'Marshtomp', 85, 60, 70, 70, 70, 50, NULL, NULL, 'Water', 'Ground', 143, 259, 'Waterfall', 'Bubble', 'Bone Club', 'Earthquake'),
(260, 'Swampert', 110, 85, 90, 90, 100, 60, NULL, NULL, 'Water', 'Ground', 210, 260, 'Bubble', 'Hydro Pump', 'Earthquake', 'Bone Club'),
(261, 'Poochyena', 55, 30, 35, 30, 35, 35, NULL, NULL, 'Dark', NULL, 55, 261, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(262, 'Mightyena', 90, 60, 70, 60, 70, 70, NULL, NULL, 'Dark', NULL, 128, 262, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(263, 'Zigzagoon', 30, 30, 41, 41, 38, 60, NULL, NULL, 'Normal', NULL, 60, 263, 'Constrict', 'Dizzy Punch', 'Slash', 'Razor Wind'),
(264, 'Linoone', 70, 50, 61, 61, 78, 100, NULL, NULL, 'Normal', NULL, 128, 264, 'Vice Grip', 'Hyper Fang', 'Mega Kick', 'Explosion'),
(265, 'Wurmple', 45, 20, 35, 30, 45, 20, NULL, NULL, 'Bug', NULL, 54, 265, 'Leech Life', 'Leech Life', 'Twineedle', 'Twineedle'),
(266, 'Silcoon', 35, 25, 55, 25, 50, 15, NULL, NULL, 'Bug', NULL, 72, 266, 'Leech Life', 'Leech Life', 'Pin Missile', 'Twineedle'),
(267, 'Beautifly', 70, 90, 50, 50, 60, 65, NULL, NULL, 'Bug', 'Flying', 161, 267, 'Twineedle', 'Twineedle', 'Drill Peck', 'Gust'),
(268, 'Cascoon', 35, 25, 55, 25, 50, 15, NULL, NULL, 'Bug', NULL, 72, 268, 'Twineedle', 'Twineedle', 'Pin Missile', 'Leech Life'),
(269, 'Dustox', 50, 50, 70, 90, 60, 65, NULL, NULL, 'Bug', 'Poison', 161, 269, 'Leech Life', 'Twineedle', 'Poison Sting', 'Sludge'),
(270, 'Lotad', 30, 40, 30, 50, 40, 30, NULL, NULL, 'Water', 'Grass', 74, 270, 'Clamp', 'Bubble', 'Mega Drain', 'Absorb'),
(271, 'Lombre', 50, 60, 50, 70, 60, 50, NULL, NULL, 'Water', 'Grass', 141, 271, 'Bubble', 'Surf', 'Solar Beam', 'Petal Dance'),
(272, 'Ludicolo', 70, 90, 70, 100, 80, 70, NULL, NULL, 'Water', 'Grass', 181, 272, 'Water Gun', 'Waterfall', 'Petal Dance', 'Absorb'),
(273, 'Seedot', 40, 30, 50, 30, 40, 30, NULL, NULL, 'Grass', NULL, 74, 273, 'Mega Drain', 'Mega Drain', 'Absorb', 'Razor Leaf'),
(274, 'Nuzleaf', 70, 60, 40, 40, 70, 60, NULL, NULL, 'Grass', 'Dark', 141, 274, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(275, 'Shiftry', 100, 90, 60, 60, 90, 80, NULL, NULL, 'Grass', 'Dark', 181, 275, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(276, 'Taillow', 55, 30, 30, 30, 40, 85, NULL, NULL, 'Normal', 'Flying', 59, 276, 'Quick Attack', 'Slam', 'Gust', 'Drill Peck'),
(277, 'Swellow', 85, 50, 60, 50, 60, 125, NULL, NULL, 'Normal', 'Flying', 162, 277, 'Cut', 'Fury Attack', 'Wing Attack', 'Drill Peck'),
(278, 'Wingull', 30, 55, 30, 30, 40, 85, NULL, NULL, 'Water', 'Flying', 64, 278, 'Crab Hammer', 'Waterfall', 'Drill Peck', 'Fly'),
(279, 'Pelipper', 50, 85, 100, 70, 60, 65, NULL, NULL, 'Water', 'Flying', 164, 279, 'Crab Hammer', 'Clamp', 'Wing Attack', 'Sky Attack'),
(280, 'Ralts', 25, 45, 25, 35, 28, 40, NULL, NULL, 'Psychic', NULL, 70, 280, 'Dream Eater', 'Psychic', 'Psybeam', 'Psybeam'),
(281, 'Kirlia', 35, 65, 35, 55, 38, 50, NULL, NULL, 'Psychic', NULL, 140, 281, 'Dream Eater', 'Confusion', 'Dream Eater', 'Dream Eater'),
(282, 'Gardevoir', 65, 125, 65, 115, 68, 80, NULL, NULL, 'Psychic', NULL, 208, 282, 'Dream Eater', 'Dream Eater', 'Confusion', 'Psybeam'),
(283, 'Surskit', 30, 50, 32, 52, 40, 65, NULL, NULL, 'Bug', 'Water', 63, 283, 'Pin Missile', 'Twineedle', 'Bubble', 'Waterfall'),
(284, 'Masquerain', 60, 80, 62, 82, 70, 60, NULL, NULL, 'Bug', 'Flying', 128, 284, 'Twineedle', 'Leech Life', 'Wing Attack', 'Drill Peck'),
(285, 'Shroomish', 40, 40, 60, 60, 60, 35, NULL, NULL, 'Grass', NULL, 65, 285, 'Absorb', 'Vine Whip', 'Vine Whip', 'Absorb'),
(286, 'Breloom', 130, 60, 80, 60, 60, 70, NULL, NULL, 'Grass', 'Fighting', 165, 286, 'Petal Dance', 'Petal Dance', 'Double Kick', 'Jump Kick'),
(287, 'Slakoth', 60, 35, 60, 35, 60, 30, NULL, NULL, 'Normal', NULL, 83, 287, 'Mega Punch', 'Hyper Beam', 'Take Down', 'Hyper Fang'),
(288, 'Vigoroth', 80, 55, 80, 55, 80, 90, NULL, NULL, 'Normal', NULL, 126, 288, 'Egg Bomb', 'Swift', 'Thrash', 'Razor Wind'),
(289, 'Slaking', 160, 95, 100, 65, 150, 100, NULL, NULL, 'Normal', NULL, 210, 289, 'Comet Punch', 'Skull Bash', 'Explosion', 'Quick Attack'),
(290, 'Nincada', 45, 30, 90, 30, 31, 40, NULL, NULL, 'Bug', 'Ground', 65, 290, 'Leech Life', 'Twineedle', 'Earthquake', 'Earthquake'),
(291, 'Ninjask', 90, 50, 45, 50, 61, 160, NULL, NULL, 'Bug', 'Flying', 155, 291, 'Leech Life', 'Pin Missile', 'Fly', 'Drill Peck'),
(292, 'Shedinja', 90, 30, 45, 30, 1, 40, NULL, NULL, 'Bug', 'Ghost', 95, 292, 'Twineedle', 'Pin Missile', 'Lick', 'Shadow Armlet'),
(293, 'Whismur', 51, 51, 23, 23, 64, 28, NULL, NULL, 'Normal', NULL, 68, 293, 'Bite', 'Pound', 'Pound', 'Strength'),
(294, 'Loudred', 71, 71, 43, 43, 84, 48, NULL, NULL, 'Normal', NULL, 126, 294, 'Quick Attack', 'Tackle', 'Stomp', 'Wrap'),
(295, 'Exploud', 91, 91, 63, 63, 104, 68, NULL, NULL, 'Normal', NULL, 184, 295, 'Constrict', 'Fury Swipes', 'Head Butt', 'Fury Swipes'),
(296, 'Makuhita', 60, 20, 30, 30, 72, 25, NULL, NULL, 'Fighting', NULL, 87, 296, 'Karate Chop', 'Jump Kick', 'Double Kick', 'Double Kick'),
(297, 'Hariyama', 120, 40, 60, 60, 144, 50, NULL, NULL, 'Fighting', NULL, 184, 297, 'Rolling Kick', 'Rolling Kick', 'Double Kick', 'Submission'),
(298, 'Azurill', 20, 20, 40, 40, 50, 20, NULL, NULL, 'Normal', NULL, 33, 298, 'Tri Attack', 'Body Slam', 'Struggle', 'Tackle'),
(299, 'Nosepass', 45, 45, 135, 90, 30, 30, NULL, NULL, 'Rock', NULL, 108, 299, 'Rock Throw', 'Rock Throw', 'Rock Throw', 'Rock Throw'),
(300, 'Skitty', 45, 35, 45, 35, 50, 50, NULL, NULL, 'Normal', NULL, 65, 300, 'Constrict', 'Strength', 'Comet Punch', 'Cut'),
(301, 'Delcatty', 65, 55, 65, 55, 70, 70, NULL, NULL, 'Normal', NULL, 138, 301, 'Mega Kick', 'Slam', 'Strength', 'Constrict'),
(302, 'Sableye', 75, 65, 75, 65, 50, 50, NULL, NULL, 'Dark', 'Ghost', 98, 302, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(303, 'Mawile', 85, 55, 85, 55, 50, 50, NULL, NULL, 'Steel', NULL, 98, 303, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(304, 'Aron', 70, 40, 100, 40, 50, 30, NULL, NULL, 'Steel', 'Rock', 96, 304, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(305, 'Lairon', 90, 50, 140, 50, 60, 40, NULL, NULL, 'Steel', 'Rock', 152, 305, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(306, 'Aggron', 110, 60, 180, 60, 70, 50, NULL, NULL, 'Steel', 'Rock', 205, 306, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(307, 'Meditite', 40, 40, 55, 55, 30, 60, NULL, NULL, 'Fighting', 'Psychic', 91, 307, 'Karate Chop', 'Jump Kick', 'Dream Eater', 'Dream Eater'),
(308, 'Medicham', 60, 60, 75, 75, 60, 80, NULL, NULL, 'Fighting', 'Psychic', 153, 308, 'Jump Kick', 'Double Kick', 'Dream Eater', 'Dream Eater'),
(309, 'Electrike', 45, 65, 40, 40, 40, 65, NULL, NULL, 'Electric', NULL, 104, 309, 'Thunder', 'Thundershock', 'Thundershock', 'Thunder Punch'),
(310, 'Manectric', 75, 105, 60, 60, 70, 105, NULL, NULL, 'Electric', NULL, 168, 310, 'Thunder Punch', 'Thunder Punch', 'Thunder', 'Thundershock'),
(311, 'Plusle', 50, 85, 40, 75, 60, 95, NULL, NULL, 'Electric', NULL, 120, 311, 'Thundershock', 'Thundershock', 'Thunder Punch', 'Thunder Punch'),
(312, 'Minun', 40, 75, 50, 85, 60, 95, NULL, NULL, 'Electric', NULL, 120, 312, 'Thunderbolt', 'Thundershock', 'Thunder', 'Thunder Punch'),
(313, 'Volbeat', 73, 47, 55, 75, 65, 85, NULL, NULL, 'Bug', NULL, 146, 313, 'Leech Life', 'Pin Missile', 'Pin Missile', 'Leech Life'),
(314, 'Illumise', 47, 73, 55, 75, 65, 85, NULL, NULL, 'Bug', NULL, 146, 314, 'Pin Missile', 'Twineedle', 'Pin Missile', 'Pin Missile'),
(315, 'Roselia', 60, 100, 45, 80, 50, 65, NULL, NULL, 'Grass', 'Poison', 152, 315, 'Solar Beam', 'Solar Beam', 'Acid', 'Acid'),
(316, 'Gulpin', 43, 43, 53, 53, 70, 40, NULL, NULL, 'Poison', NULL, 75, 316, 'Poison Sting', 'Acid', 'Sludge', 'Smog'),
(317, 'Swalot', 73, 73, 83, 83, 100, 55, NULL, NULL, 'Poison', NULL, 168, 317, 'Smog', 'Poison Sting', 'Sludge', 'Smog'),
(318, 'Carvanha', 90, 65, 20, 20, 45, 65, NULL, NULL, 'Water', 'Dark', 88, 318, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(319, 'Sharpedo', 120, 95, 40, 40, 70, 95, NULL, NULL, 'Water', 'Dark', 175, 319, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(320, 'Wailmer', 70, 70, 35, 35, 130, 60, NULL, NULL, 'Water', NULL, 137, 320, 'Water Gun', 'Clamp', 'Bubblebeam', 'Hydro Pump'),
(321, 'Wailord', 90, 90, 45, 45, 170, 60, NULL, NULL, 'Water', NULL, 206, 321, 'Bubble', 'Hydro Pump', 'Crab Hammer', 'Bubble'),
(322, 'Numel', 60, 65, 40, 45, 60, 35, NULL, NULL, 'Fire', 'Ground', 88, 322, 'Fire Blast', 'Ember', 'Bonemerang', 'Bone Club'),
(323, 'Camerupt', 100, 105, 70, 75, 70, 40, NULL, NULL, 'Fire', 'Ground', 175, 323, 'Fire Blast', 'Ember', 'Dig', 'Bone Club'),
(324, 'Torkoal', 85, 85, 140, 70, 70, 20, NULL, NULL, 'Fire', NULL, 161, 324, 'Ember', 'Fire Blast', 'Fire Punch', 'Fire Punch'),
(325, 'Spoink', 25, 70, 35, 80, 60, 60, NULL, NULL, 'Psychic', NULL, 89, 325, 'Dream Eater', 'Psybeam', 'Psybeam', 'Dream Eater'),
(326, 'Grumpig', 45, 90, 65, 110, 80, 80, NULL, NULL, 'Psychic', NULL, 164, 326, 'Dream Eater', 'Psychic', 'Confusion', 'Dream Eater'),
(327, 'Spinda', 60, 60, 60, 60, 60, 60, NULL, NULL, 'Normal', NULL, 85, 327, 'Rage', 'Cut', 'Self Destruct', 'Wrap'),
(328, 'Trapinch', 100, 45, 45, 45, 45, 10, NULL, NULL, 'Ground', NULL, 73, 328, 'Bonemerang', 'Dig', 'Bonemerang', 'Bone Club'),
(329, 'Vibrava', 70, 50, 50, 50, 50, 70, NULL, NULL, 'Ground', 'Dragon', 126, 329, 'Earthquake', 'Bone Club', 'Dragon Rage', 'Dragon Rage'),
(330, 'Flygon', 100, 80, 80, 80, 80, 100, NULL, NULL, 'Ground', 'Dragon', 197, 330, 'Bonemerang', 'Bonemerang', 'Dragon Rage', 'Dragon Rage'),
(331, 'Cacnea', 85, 85, 40, 40, 50, 35, NULL, NULL, 'Grass', NULL, 97, 331, 'Vine Whip', 'Vine Whip', 'Vine Whip', 'Razor Leaf'),
(332, 'Cacturne', 115, 115, 60, 60, 70, 55, NULL, NULL, 'Grass', 'Dark', 177, 332, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(333, 'Swablu', 40, 40, 60, 75, 45, 50, NULL, NULL, 'Normal', 'Flying', 74, 333, 'Quick Attack', 'Constrict', 'Drill Peck', 'Peck'),
(334, 'Altaria', 70, 70, 90, 105, 75, 80, NULL, NULL, 'Dragon', 'Flying', 188, 334, 'Dragon Rage', 'Dragon Rage', 'Wing Attack', 'Gust'),
(335, 'Zangoose', 115, 60, 60, 60, 73, 90, NULL, NULL, 'Normal', NULL, 165, 335, 'Scratch', 'Spike Cannon', 'Skull Bash', 'Self Destruct'),
(336, 'Seviper', 100, 100, 60, 60, 73, 65, NULL, NULL, 'Poison', NULL, 165, 336, 'Acid', 'Sludge', 'Poison Sting', 'Smog'),
(337, 'Lunatone', 55, 95, 65, 85, 70, 70, NULL, NULL, 'Rock', 'Psychic', 150, 337, 'Rock Slide', 'Rock Throw', 'Confusion', 'Psychic'),
(338, 'SolRock', 95, 55, 85, 65, 70, 70, NULL, NULL, 'Rock', 'Psychic', 150, 338, 'Rock Throw', 'Rock Throw', 'Psychic', 'Confusion'),
(339, 'Barboach', 48, 46, 43, 41, 50, 60, NULL, NULL, 'Water', 'Ground', 92, 339, 'Hydro Pump', 'Bubble', 'Earthquake', 'Bonemerang'),
(340, 'Whiscash', 78, 76, 73, 71, 110, 60, NULL, NULL, 'Water', 'Ground', 158, 340, 'Bubble', 'Clamp', 'Earthquake', 'Bone Club'),
(341, 'Corphish', 80, 50, 65, 35, 43, 35, NULL, NULL, 'Water', NULL, 111, 341, 'Water Gun', 'Surf', 'Bubblebeam', 'Water Gun'),
(342, 'Crawdaunt', 120, 90, 85, 55, 63, 55, NULL, NULL, 'Water', 'Dark', 161, 342, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(343, 'Baltoy', 40, 40, 55, 70, 40, 55, NULL, NULL, 'Ground', 'Psychic', 58, 343, 'Bone Club', 'Bone Club', 'Confusion', 'Confusion'),
(344, 'Claydol', 70, 70, 105, 120, 60, 75, NULL, NULL, 'Ground', 'Psychic', 189, 344, 'Bonemerang', 'Dig', 'Psychic', 'Dream Eater'),
(345, 'Lileep', 41, 61, 77, 87, 66, 23, NULL, NULL, 'Rock', 'Grass', 99, 345, 'Rock Slide', 'Rock Throw', 'Solar Beam', 'Vine Whip'),
(346, 'Cradily', 81, 81, 97, 107, 86, 43, NULL, NULL, 'Rock', 'Grass', 199, 346, 'Rock Slide', 'Rock Throw', 'Solar Beam', 'Petal Dance'),
(347, 'Anorith', 95, 40, 50, 50, 45, 75, NULL, NULL, 'Rock', 'Bug', 99, 347, 'Rock Throw', 'Rock Throw', 'Pin Missile', 'Twineedle'),
(348, 'Armaldo', 125, 70, 100, 80, 75, 45, NULL, NULL, 'Rock', 'Bug', 199, 348, 'Rock Slide', 'Rock Slide', 'Leech Life', 'Twineedle'),
(349, 'Feebas', 15, 10, 20, 55, 20, 80, NULL, NULL, 'Water', NULL, 61, 349, 'Waterfall', 'Waterfall', 'Bubble', 'Bubble'),
(350, 'Milotic', 60, 100, 79, 125, 95, 81, NULL, NULL, 'Water', NULL, 213, 350, 'Crab Hammer', 'Bubble', 'Bubblebeam', 'Bubblebeam'),
(351, 'Castform', 70, 70, 70, 70, 70, 70, NULL, NULL, 'Normal', NULL, 145, 351, 'Comet Punch', 'Explosion', 'Bite', 'Wrap'),
(352, 'Kecleon', 90, 60, 70, 120, 60, 40, NULL, NULL, 'Normal', NULL, 132, 352, 'Doubleslap', 'Stomp', 'Thrash', 'Rage'),
(353, 'Shuppet', 75, 63, 35, 33, 44, 45, NULL, NULL, 'Ghost', NULL, 97, 353, 'Shadow Armlet', 'Shadow Armlet', 'Shadow Armlet', 'Shadow Armlet'),
(354, 'Banette', 115, 83, 65, 63, 64, 65, NULL, NULL, 'Ghost', NULL, 179, 354, 'Lick', 'Lick', 'Lick', 'Shadow Armlet'),
(355, 'Duskull', 40, 30, 90, 90, 20, 25, NULL, NULL, 'Ghost', NULL, 97, 355, 'Lick', 'Lick', 'Shadow Armlet', 'Lick'),
(356, 'Dusclops', 70, 60, 130, 130, 40, 25, NULL, NULL, 'Ghost', NULL, 179, 356, 'Lick', 'Lick', 'Lick', 'Shadow Armlet'),
(357, 'Tropius', 68, 72, 83, 87, 99, 51, NULL, NULL, 'Grass', 'Flying', 169, 357, 'Vine Whip', 'Petal Dance', 'Fly', 'Fly'),
(358, 'Chimecho', 50, 95, 70, 80, 65, 65, NULL, NULL, 'Psychic', NULL, 147, 358, 'Psybeam', 'Confusion', 'Psybeam', 'Psybeam'),
(359, 'Absol', 130, 75, 60, 60, 65, 75, NULL, NULL, 'Dark', NULL, 174, 359, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(360, 'Wynaut', 23, 23, 48, 48, 95, 23, NULL, NULL, 'Psychic', NULL, 44, 360, 'Confusion', 'Psychic', 'Dream Eater', 'Psybeam'),
(361, 'Snorunt', 50, 50, 50, 50, 50, 50, NULL, NULL, 'Ice', NULL, 74, 361, 'Ice Punch', 'Blizzard', 'Ice Beam', 'Ice Punch'),
(362, 'Glalie', 80, 80, 80, 80, 80, 80, NULL, NULL, 'Ice', NULL, 187, 362, 'Aurora Beam', 'Ice Punch', 'Ice Beam', 'Ice Punch'),
(363, 'Spheal', 40, 55, 50, 50, 70, 25, NULL, NULL, 'Ice', 'Water', 75, 363, 'Aurora Beam', 'Ice Beam', 'Bubble', 'Bubble'),
(364, 'Sealeo', 60, 75, 70, 70, 90, 45, NULL, NULL, 'Ice', 'Water', 128, 364, 'Ice Punch', 'Ice Punch', 'Crab Hammer', 'Water Gun'),
(365, 'Walrein', 80, 95, 90, 90, 110, 65, NULL, NULL, 'Ice', 'Water', 192, 365, 'Aurora Beam', 'Ice Punch', 'Waterfall', 'Crab Hammer'),
(366, 'Clamperl', 64, 74, 85, 55, 35, 32, NULL, NULL, 'Water', NULL, 142, 366, 'Water Gun', 'Clamp', 'Bubblebeam', 'Bubblebeam'),
(367, 'Huntail', 104, 94, 105, 75, 55, 52, NULL, NULL, 'Water', NULL, 178, 367, 'Hydro Pump', 'Crab Hammer', 'Hydro Pump', 'Clamp'),
(368, 'Gorebyss', 84, 114, 105, 75, 55, 52, NULL, NULL, 'Water', NULL, 178, 368, 'Hydro Pump', 'Waterfall', 'Bubble', 'Surf'),
(369, 'Relicanth', 90, 45, 130, 65, 100, 55, NULL, NULL, 'Water', 'Rock', 198, 369, 'Surf', 'Water Gun', 'Rock Throw', 'Rock Throw'),
(370, 'Luvdisc', 30, 40, 55, 65, 43, 97, NULL, NULL, 'Water', NULL, 110, 370, 'Clamp', 'Water Gun', 'Bubblebeam', 'Hydro Pump'),
(371, 'Bagon', 75, 40, 60, 30, 45, 50, NULL, NULL, 'Dragon', NULL, 89, 371, 'Dragon Rage', 'Dragon Rage', 'Dragon Rage', 'Dragon Rage'),
(372, 'Shelgon', 95, 60, 100, 50, 65, 50, NULL, NULL, 'Dragon', NULL, 144, 372, 'Dragon Rage', 'Dragon Rage', 'Dragon Rage', 'Dragon Rage'),
(373, 'Salamence', 135, 110, 80, 80, 95, 100, NULL, NULL, 'Dragon', 'Flying', 218, 373, 'Dragon Rage', 'Dragon Rage', 'Fly', 'Gust'),
(374, 'Beldum', 55, 35, 80, 60, 40, 30, NULL, NULL, 'Steel', 'Psychic', 103, 374, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(375, 'Metang', 75, 55, 100, 80, 60, 50, NULL, NULL, 'Steel', 'Psychic', 153, 375, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(376, 'Metagross', 135, 95, 130, 90, 80, 70, NULL, NULL, 'Steel', 'Psychic', 210, 376, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(377, 'RegiRock', 100, 50, 200, 100, 80, 50, NULL, NULL, 'Rock', NULL, 217, 377, 'Rock Throw', 'Rock Slide', 'Rock Slide', 'Rock Slide'),
(378, 'RegIce', 50, 100, 100, 200, 80, 50, NULL, NULL, 'Ice', NULL, 216, 378, 'Ice Punch', 'Blizzard', 'Ice Punch', 'Aurora Beam'),
(379, 'RegiSteel', 75, 75, 150, 150, 80, 50, NULL, NULL, 'Steel', NULL, 215, 379, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(380, 'Latias', 80, 110, 90, 130, 80, 110, NULL, NULL, 'Dragon', 'Psychic', 211, 380, 'Dragon Rage', 'Dragon Rage', 'Psychic', 'Confusion'),
(381, 'Latios', 90, 130, 80, 110, 80, 110, NULL, NULL, 'Dragon', 'Psychic', 211, 381, 'Dragon Rage', 'Dragon Rage', 'Dream Eater', 'Confusion'),
(382, 'Kyogre', 100, 150, 90, 140, 100, 90, NULL, NULL, 'Water', NULL, 218, 382, 'Surf', 'Crab Hammer', 'Surf', 'Water Gun'),
(383, 'Groudon', 150, 100, 140, 90, 100, 90, NULL, NULL, 'Ground', NULL, 218, 383, 'Dig', 'Bone Club', 'Bonemerang', 'Earthquake'),
(384, 'Rayquaza', 150, 150, 90, 90, 105, 95, NULL, NULL, 'Dragon', 'Flying', 220, 384, 'Dragon Rage', 'Dragon Rage', 'Sky Attack', 'Wing Attack');
INSERT INTO `pokedex` (`id`, `name`, `attack`, `spattack`, `def`, `spdef`, `hp`, `speed`, `evolution`, `level`, `type1`, `type2`, `exp`, `num`, `move1`, `move2`, `move3`, `move4`) VALUES
(385, 'Jirachi', 100, 100, 100, 100, 100, 100, NULL, NULL, 'Steel', 'Psychic', 215, 385, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(386, 'Deoxys', 150, 150, 50, 50, 50, 150, NULL, NULL, 'Psychic', NULL, 215, 386, 'Psybeam', 'Dream Eater', 'Psybeam', 'Psybeam'),
(387, 'Turtwig', 68, 45, 64, 55, 55, 31, NULL, NULL, 'Grass', NULL, 64, 387, 'Razor Leaf', 'Solar Beam', 'Solar Beam', 'Solar Beam'),
(388, 'Grotle', 89, 55, 85, 65, 75, 36, NULL, NULL, 'Grass', NULL, 141, 388, 'Petal Dance', 'Absorb', 'Absorb', 'Petal Dance'),
(389, 'Torterra', 109, 75, 105, 85, 95, 56, NULL, NULL, 'Grass', 'Ground', 208, 389, 'Mega Drain', 'Petal Dance', 'Bonemerang', 'Dig'),
(390, 'Chimchar', 58, 58, 44, 44, 44, 61, NULL, NULL, 'Fire', NULL, 65, 390, 'Ember', 'Fire Blast', 'Flamethrower', 'Fire Blast'),
(391, 'Monferno', 78, 78, 52, 52, 64, 81, NULL, NULL, 'Fire', 'Fighting', 142, 391, 'Fire Blast', 'Ember', 'Karate Chop', 'Jump Kick'),
(392, 'Infernape', 104, 104, 71, 71, 76, 108, NULL, NULL, 'Fire', 'Fighting', 209, 392, 'Fire Spin', 'Fire Punch', 'Karate Chop', 'Double Kick'),
(393, 'Piplup', 51, 61, 53, 56, 53, 40, NULL, NULL, 'Water', NULL, 66, 393, 'Hydro Pump', 'Water Gun', 'Surf', 'Clamp'),
(394, 'Prinplup', 66, 81, 68, 76, 64, 50, NULL, NULL, 'Water', NULL, 143, 394, 'Surf', 'Waterfall', 'Clamp', 'Water Gun'),
(395, 'Empoleon', 86, 111, 88, 101, 84, 60, NULL, NULL, 'Water', 'Steel', 210, 395, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(396, 'Starly', 55, 30, 30, 30, 40, 60, NULL, NULL, 'Normal', 'Flying', 56, 396, 'Wrap', 'Egg Bomb', 'Gust', 'Wing Attack'),
(397, 'Staravia', 75, 40, 50, 40, 55, 80, NULL, NULL, 'Normal', 'Flying', 113, 397, 'Head Butt', 'Rage', 'Gust', 'Gust'),
(398, 'Staraptor', 120, 50, 70, 50, 85, 100, NULL, NULL, 'Normal', 'Flying', 172, 398, 'Pay Day', 'Bind', 'Drill Peck', 'Fly'),
(399, 'Bidoof', 45, 35, 40, 40, 59, 31, NULL, NULL, 'Normal', NULL, 58, 399, 'Dizzy Punch', 'Egg Bomb', 'Take Down', 'Double Edge'),
(400, 'Bibarel', 85, 55, 60, 60, 79, 71, NULL, NULL, 'Normal', 'Water', 116, 400, 'Bind', 'Skull Bash', 'Water Gun', 'Crab Hammer'),
(401, 'Kricketot', 25, 25, 41, 41, 37, 25, NULL, NULL, 'Bug', NULL, 54, 401, 'Pin Missile', 'Pin Missile', 'Pin Missile', 'Pin Missile'),
(402, 'Kricketune', 85, 55, 51, 51, 77, 65, NULL, NULL, 'Bug', NULL, 159, 402, 'Leech Life', 'Leech Life', 'Twineedle', 'Leech Life'),
(403, 'Shinx', 65, 40, 34, 34, 45, 45, NULL, NULL, 'Electric', NULL, 60, 403, 'Thundershock', 'Thunder', 'Thunderbolt', 'Thunder'),
(404, 'Luxio', 85, 60, 49, 49, 60, 60, NULL, NULL, 'Electric', NULL, 117, 404, 'Thundershock', 'Thunderbolt', 'Thunder', 'Thunder'),
(405, 'Luxray', 120, 95, 79, 79, 80, 70, NULL, NULL, 'Electric', NULL, 194, 405, 'Thunderbolt', 'Thunder Punch', 'Thunder', 'Thunder'),
(406, 'Budew', 30, 50, 35, 70, 40, 55, NULL, NULL, 'Grass', 'Poison', 68, 406, 'Razor Leaf', 'Razor Leaf', 'Sludge', 'Sludge'),
(407, 'Roserade', 70, 125, 55, 105, 60, 90, NULL, NULL, 'Grass', 'Poison', 204, 407, 'Mega Drain', 'Vine Whip', 'Smog', 'Acid'),
(408, 'Cranidos', 125, 30, 40, 30, 67, 58, NULL, NULL, 'Rock', NULL, 99, 408, 'Rock Slide', 'Rock Throw', 'Rock Throw', 'Rock Slide'),
(409, 'Rampardos', 165, 65, 60, 50, 97, 58, NULL, NULL, 'Rock', NULL, 199, 409, 'Rock Throw', 'Rock Throw', 'Rock Slide', 'Rock Slide'),
(410, 'Shieldon', 42, 42, 118, 88, 30, 30, NULL, NULL, 'Rock', 'Steel', 99, 410, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(411, 'Bastiodon', 52, 47, 168, 138, 60, 30, NULL, NULL, 'Rock', 'Steel', 199, 411, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(412, 'Burmy', 29, 29, 45, 45, 40, 36, NULL, NULL, 'Bug', NULL, 61, 412, 'Twineedle', 'Leech Life', 'Leech Life', 'Leech Life'),
(413, 'Wormadam', 59, 79, 85, 105, 60, 36, NULL, NULL, 'Bug', 'Grass', 159, 413, 'Twineedle', 'Leech Life', 'Mega Drain', 'Razor Leaf'),
(414, 'Mothim', 94, 94, 50, 50, 70, 66, NULL, NULL, 'Bug', 'Flying', 159, 414, 'Twineedle', 'Twineedle', 'Peck', 'Peck'),
(415, 'Combee', 30, 30, 42, 42, 30, 70, NULL, NULL, 'Bug', 'Flying', 63, 415, 'Leech Life', 'Leech Life', 'Peck', 'Wing Attack'),
(416, 'Vespiquen', 80, 80, 102, 102, 70, 40, NULL, NULL, 'Bug', 'Flying', 188, 416, 'Leech Life', 'Leech Life', 'Sky Attack', 'Fly'),
(417, 'Pachirisu', 45, 45, 70, 90, 60, 95, NULL, NULL, 'Electric', NULL, 120, 417, 'Thunderbolt', 'Thunder', 'Thunder', 'Thunder Punch'),
(418, 'Buizel', 65, 60, 35, 30, 55, 85, NULL, NULL, 'Water', NULL, 75, 418, 'Surf', 'Surf', 'Clamp', 'Hydro Pump'),
(419, 'Floatzel', 105, 85, 55, 50, 85, 115, NULL, NULL, 'Water', NULL, 178, 419, 'Water Gun', 'Surf', 'Surf', 'Crab Hammer'),
(420, 'Cherubi', 35, 62, 45, 53, 45, 35, NULL, NULL, 'Grass', NULL, 68, 420, 'Absorb', 'Mega Drain', 'Petal Dance', 'Absorb'),
(421, 'Cherrim', 60, 87, 70, 78, 70, 85, NULL, NULL, 'Grass', NULL, 133, 421, 'Vine Whip', 'Vine Whip', 'Vine Whip', 'Solar Beam'),
(422, 'Shellos', 48, 57, 48, 62, 76, 34, NULL, NULL, 'Water', '', 73, 422, 'Absorb', 'Absorb', 'Absorb', 'Absorb'),
(423, 'Gastrodon', 83, 92, 68, 82, 111, 39, NULL, NULL, 'Water', 'Ground', 176, 423, 'Absorb', 'Absorb', 'Absorb', 'Absorb'),
(424, 'Ambipom', 100, 60, 66, 66, 75, 115, NULL, NULL, 'Normal', NULL, 186, 424, 'Take Down', 'Fury Attack', 'Struggle', 'Horn Attack'),
(425, 'Drifloon', 50, 60, 34, 44, 90, 70, NULL, NULL, 'Ghost', 'Flying', 127, 425, 'Shadow Armlet', 'Lick', 'Gust', 'Drill Peck'),
(426, 'Drifblim', 80, 90, 44, 54, 150, 80, NULL, NULL, 'Ghost', 'Flying', 204, 426, 'Shadow Armlet', 'Shadow Armlet', 'Drill Peck', 'Sky Attack'),
(427, 'Buneary', 66, 44, 44, 56, 55, 85, NULL, NULL, 'Normal', NULL, 84, 427, 'Comet Punch', 'Struggle', 'Self Destruct', 'Double Edge'),
(428, 'Lopunny', 76, 54, 84, 96, 65, 105, NULL, NULL, 'Normal', NULL, 178, 428, 'Swift', 'Cut', 'Self Destruct', 'Fury Attack'),
(429, 'Mismagius', 60, 105, 60, 105, 60, 105, NULL, NULL, 'Ghost', NULL, 187, 429, 'Shadow Armlet', 'Shadow Armlet', 'Shadow Armlet', 'Shadow Armlet'),
(430, 'Honchkrow', 125, 105, 52, 52, 100, 71, NULL, NULL, 'Dark', 'Flying', 187, 430, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(431, 'Glameow', 55, 42, 42, 37, 49, 85, NULL, NULL, 'Normal', NULL, 71, 431, 'Dizzy Punch', 'Vice Grip', 'Strength', 'Rage'),
(432, 'Purugly', 82, 64, 64, 59, 71, 112, NULL, NULL, 'Normal', NULL, 183, 432, 'Cut', 'Barrage', 'Fury Attack', 'Constrict'),
(433, 'Chingling', 30, 65, 50, 50, 45, 45, NULL, NULL, 'Psychic', NULL, 74, 433, 'Psychic', 'Dream Eater', 'Confusion', 'Psybeam'),
(434, 'Stunky', 63, 41, 47, 41, 63, 74, NULL, NULL, 'Poison', 'Dark', 79, 434, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(435, 'Skuntank', 93, 71, 67, 61, 103, 84, NULL, NULL, 'Poison', 'Dark', 209, 435, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(436, 'Bronzor', 24, 24, 86, 86, 57, 23, NULL, NULL, 'Steel', 'Psychic', 72, 436, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(437, 'Bronzong', 89, 79, 116, 116, 67, 33, NULL, NULL, 'Steel', 'Psychic', 188, 437, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(438, 'Bonsly', 80, 10, 95, 45, 50, 10, NULL, NULL, 'Rock', NULL, 68, 438, 'Rock Slide', 'Rock Slide', 'Rock Slide', 'Rock Throw'),
(439, 'Mime Jr.', 25, 70, 45, 90, 20, 60, NULL, NULL, 'Psychic', '', 78, 439, 'Absorb', 'Absorb', 'Absorb', 'Absorb'),
(440, 'Happiny', 5, 15, 5, 65, 100, 30, NULL, NULL, 'Normal', NULL, 255, 440, 'Quick Attack', 'Hyper Beam', 'Mega Punch', 'Egg Bomb'),
(441, 'Chatot', 65, 92, 45, 42, 76, 91, NULL, NULL, 'Normal', 'Flying', 107, 441, 'Mega Kick', 'Comet Punch', 'Peck', 'Wing Attack'),
(442, 'Spiritomb', 92, 92, 108, 108, 50, 35, NULL, NULL, 'Ghost', 'Dark', 168, 442, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(443, 'Gible', 70, 40, 45, 45, 58, 42, NULL, NULL, 'Dragon', 'Ground', 67, 443, 'Dragon Rage', 'Dragon Rage', 'Bonemerang', 'Bone Club'),
(444, 'Gabite', 90, 50, 65, 55, 68, 82, NULL, NULL, 'Dragon', 'Ground', 144, 444, 'Dragon Rage', 'Dragon Rage', 'Bone Club', 'Bonemerang'),
(445, 'Garchomp', 130, 80, 95, 85, 108, 102, NULL, NULL, 'Dragon', 'Ground', 218, 445, 'Dragon Rage', 'Dragon Rage', 'Dig', 'Bonemerang'),
(446, 'Munchlax', 85, 40, 40, 85, 135, 5, NULL, NULL, 'Normal', NULL, 94, 446, 'Mega Kick', 'Head Butt', 'Dizzy Punch', 'Hyper Fang'),
(447, 'Riolu', 70, 35, 40, 40, 40, 60, NULL, NULL, 'Fighting', NULL, 72, 447, 'Jump Kick', 'Karate Chop', 'Submission', 'Karate Chop'),
(448, 'Lucario', 110, 115, 70, 70, 70, 90, NULL, NULL, 'Fighting', 'Steel', 204, 448, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(449, 'Hippopotas', 72, 38, 78, 42, 68, 32, NULL, NULL, 'Ground', NULL, 95, 449, 'Earthquake', 'Earthquake', 'Bonemerang', 'Bone Club'),
(450, 'Hippowdon', 112, 68, 118, 72, 108, 47, NULL, NULL, 'Ground', NULL, 198, 450, 'Bone Club', 'Dig', 'Bonemerang', 'Earthquake'),
(451, 'Skorupi', 50, 30, 90, 55, 40, 65, NULL, NULL, 'Poison', 'Bug', 114, 451, 'Poison Sting', 'Acid', 'Leech Life', 'Twineedle'),
(452, 'Drapion', 90, 60, 110, 75, 70, 95, NULL, NULL, 'Poison', 'Dark', 204, 452, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(453, 'Croagunk', 61, 61, 40, 40, 48, 50, NULL, NULL, 'Poison', 'Fighting', 83, 453, 'Sludge', 'Smog', 'Double Kick', 'Jump Kick'),
(454, 'Toxicroak', 106, 86, 65, 65, 83, 85, NULL, NULL, 'Poison', 'Fighting', 181, 454, 'Acid', 'Acid', 'Rolling Kick', 'Rolling Kick'),
(455, 'Carnivine', 100, 90, 72, 72, 74, 46, NULL, NULL, 'Grass', NULL, 164, 455, 'Absorb', 'Razor Leaf', 'Solar Beam', 'Petal Dance'),
(456, 'Finneon', 49, 49, 56, 61, 49, 66, NULL, NULL, 'Water', NULL, 90, 456, 'Clamp', 'Bubblebeam', 'Hydro Pump', 'Hydro Pump'),
(457, 'Lumineon', 69, 69, 76, 86, 69, 91, NULL, NULL, 'Water', NULL, 156, 457, 'Clamp', 'Clamp', 'Waterfall', 'Hydro Pump'),
(458, 'Mantyke', 20, 60, 50, 120, 45, 50, NULL, NULL, 'Water', 'Flying', 108, 458, 'Clamp', 'Bubble', 'Wing Attack', 'Fly'),
(459, 'Snover', 62, 62, 50, 60, 60, 40, NULL, NULL, 'Grass', 'Ice', 131, 459, 'Vine Whip', 'Absorb', 'Aurora Beam', 'Ice Beam'),
(460, 'Abomasnow', 92, 92, 75, 85, 90, 60, NULL, NULL, 'Grass', 'Ice', 214, 460, 'Razor Leaf', 'Petal Dance', 'Blizzard', 'Aurora Beam'),
(461, 'Weavile', 120, 45, 65, 85, 70, 125, NULL, NULL, 'Dark', 'Ice', 199, 461, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(462, 'Magnezone', 70, 130, 115, 90, 70, 60, NULL, NULL, 'Electric', 'Steel', 211, 462, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(463, 'Lickilicky', 85, 80, 95, 95, 110, 50, NULL, NULL, 'Normal', NULL, 193, 463, 'Wrap', 'Constrict', 'Double Edge', 'Fury Attack'),
(464, 'Rhyperior', 140, 55, 130, 55, 115, 40, NULL, NULL, 'Ground', 'Rock', 217, 464, 'Bonemerang', 'Dig', 'Rock Throw', 'Rock Slide'),
(465, 'Tangrowth', 100, 110, 125, 50, 100, 50, NULL, NULL, 'Grass', NULL, 211, 465, 'Vine Whip', 'Razor Leaf', 'Vine Whip', 'Mega Drain'),
(466, 'Electivire', 123, 95, 67, 85, 75, 95, NULL, NULL, 'Electric', NULL, 199, 466, 'Thunder Punch', 'Thundershock', 'Thunder', 'Thunder'),
(467, 'Magmortar', 95, 125, 67, 95, 75, 83, NULL, NULL, 'Fire', NULL, 199, 467, 'Flamethrower', 'Ember', 'Fire Blast', 'Fire Spin'),
(468, 'Togekiss', 50, 120, 95, 115, 85, 80, NULL, NULL, 'Normal', 'Flying', 220, 468, 'Slam', 'Bite', 'Sky Attack', 'Wing Attack'),
(469, 'Yanmega', 76, 116, 86, 56, 86, 95, NULL, NULL, 'Bug', 'Flying', 198, 469, 'Leech Life', 'Pin Missile', 'Wing Attack', 'Peck'),
(470, 'Leafeon', 110, 60, 130, 65, 65, 95, NULL, NULL, 'Grass', NULL, 196, 470, 'Solar Beam', 'Vine Whip', 'Solar Beam', 'Vine Whip'),
(471, 'Glaceon', 60, 130, 110, 95, 65, 65, NULL, NULL, 'Ice', NULL, 196, 471, 'Aurora Beam', 'Blizzard', 'Blizzard', 'Ice Punch'),
(472, 'Gliscor', 95, 45, 125, 75, 75, 95, NULL, NULL, 'Ground', 'Flying', 192, 472, 'Dig', 'Dig', 'Fly', 'Sky Attack'),
(473, 'Mamoswine', 130, 70, 80, 60, 110, 80, NULL, NULL, 'Ice', 'Ground', 207, 473, 'Ice Punch', 'Ice Beam', 'Bone Club', 'Dig'),
(474, 'Porygon-Z', 80, 135, 70, 75, 85, 90, NULL, NULL, 'Normal', NULL, 185, 474, 'Tackle', 'Dizzy Punch', 'Cut', 'Horn Attack'),
(475, 'Gallade', 125, 65, 65, 115, 68, 80, NULL, NULL, 'Psychic', 'Fighting', 208, 475, 'Psychic', 'Psybeam', 'Rolling Kick', 'Jump Kick'),
(476, 'Probopass', 55, 75, 145, 150, 60, 40, NULL, NULL, 'Rock', 'Steel', 198, 476, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(477, 'Dusknoir', 100, 65, 135, 135, 45, 45, NULL, NULL, 'Ghost', NULL, 210, 477, 'Lick', 'Shadow Armlet', 'Lick', 'Lick'),
(478, 'Froslass', 80, 80, 70, 70, 70, 110, NULL, NULL, 'Ice', 'Ghost', 187, 478, 'Blizzard', 'Aurora Beam', 'Lick', 'Shadow Armlet'),
(479, 'Rotom', 50, 95, 77, 77, 50, 91, NULL, NULL, 'Electric', 'Ghost', 132, 479, 'Thunder', 'Thunder', 'Shadow Armlet', 'Shadow Armlet'),
(480, 'Uxie', 75, 75, 130, 130, 75, 95, NULL, NULL, 'Psychic', NULL, 210, 480, 'Psychic', 'Psychic', 'Psybeam', 'Psychic'),
(481, 'Mesprit', 105, 105, 105, 105, 80, 80, NULL, NULL, 'Psychic', NULL, 210, 481, 'Psychic', 'Psybeam', 'Dream Eater', 'Confusion'),
(482, 'Azelf', 125, 125, 70, 70, 75, 115, NULL, NULL, 'Psychic', NULL, 210, 482, 'Psychic', 'Psybeam', 'Psychic', 'Confusion'),
(483, 'Dialga', 120, 150, 120, 100, 100, 90, NULL, NULL, 'Steel', 'Dragon', 220, 483, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(484, 'Palkia', 120, 150, 100, 120, 90, 100, NULL, NULL, 'Water', 'Dragon', 220, 484, 'Bubble', 'Waterfall', 'Dragon Rage', 'Dragon Rage'),
(485, 'Heatran', 90, 130, 106, 106, 91, 77, NULL, NULL, 'Fire', 'Steel', 215, 485, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(486, 'Regigigas', 160, 80, 110, 110, 110, 100, NULL, NULL, 'Normal', NULL, 220, 486, 'Comet Punch', 'Struggle', 'Mega Punch', 'Scratch'),
(487, 'Giratina', 100, 100, 120, 120, 150, 90, NULL, NULL, 'Ghost', 'Dragon', 220, 487, 'Lick', 'Shadow Armlet', 'Dragon Rage', 'Dragon Rage'),
(488, 'Cresselia', 70, 75, 120, 130, 120, 85, NULL, NULL, 'Psychic', NULL, 210, 488, 'Psybeam', 'Psybeam', 'Psychic', 'Confusion'),
(489, 'Phione', 80, 80, 80, 80, 80, 80, NULL, NULL, 'Water', NULL, 165, 489, 'Crab Hammer', 'Bubble', 'Crab Hammer', 'Hydro Pump'),
(490, 'Manaphy', 100, 100, 100, 100, 100, 100, NULL, NULL, 'Water', NULL, 215, 490, 'Crab Hammer', 'Hydro Pump', 'Bubble', 'Crab Hammer'),
(491, 'Darkrai', 90, 135, 90, 90, 70, 125, NULL, NULL, 'Dark', NULL, 210, 491, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(492, 'Shaymin', 100, 100, 100, 100, 100, 100, NULL, NULL, 'Grass', NULL, 64, 492, 'Petal Dance', 'Petal Dance', 'Petal Dance', 'Mega Drain'),
(493, 'Arceus', 120, 120, 120, 120, 120, 120, NULL, NULL, 'Normal', NULL, 255, 493, 'Wrap', 'Comet Punch', 'Take Down', 'Skull Bash'),
(494, 'Victini', 100, 100, 100, 100, 100, 100, NULL, NULL, 'Psychic', 'Fire', 100, 494, 'Dream Eater', 'Confusion', 'Fire Blast', 'Fire Spin'),
(495, 'Snivy', 45, 45, 55, 55, 45, 63, 'Servine', NULL, 'Grass', NULL, 100, 495, 'Solar Beam', 'Petal Dance', 'Mega Drain', 'Solar Beam'),
(496, 'Servine', 60, 60, 75, 75, 60, 83, 'Serperior', 17, 'Grass', NULL, 100, 496, 'Solar Beam', 'Mega Drain', 'Razor Leaf', 'Absorb'),
(497, 'Serperior', 75, 75, 95, 95, 75, 113, NULL, 36, 'Grass', NULL, 100, 497, 'Solar Beam', 'Vine Whip', 'Absorb', 'Solar Beam'),
(498, 'Tepig', 63, 45, 45, 45, 65, 45, 'Pignite', NULL, 'Fire', NULL, 100, 498, 'Fire Spin', 'Ember', 'Flamethrower', 'Fire Spin'),
(499, 'Pignite', 93, 70, 55, 55, 90, 55, 'Emboar', NULL, 'Fire', 'Fightint', 100, 499, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(500, 'Emboar', 123, 100, 65, 65, 110, 65, NULL, NULL, 'Fire', 'Fighting', 100, 500, 'Flamethrower', 'Fire Punch', 'Jump Kick', 'Rolling Kick'),
(501, 'Oshawott', 55, 63, 45, 45, 55, 45, 'Dewott', NULL, 'Water', NULL, 100, 501, 'Bubble', 'Crab Hammer', 'Crab Hammer', 'Bubble'),
(502, 'Dewott', 75, 83, 60, 60, 75, 60, 'Samurott', NULL, 'Water', NULL, 100, 502, 'Bubble', 'Surf', 'Clamp', 'Water Gun'),
(503, 'Samurott', 100, 108, 85, 70, 95, 70, NULL, NULL, 'Water', NULL, 100, 503, 'Water Gun', 'Crab Hammer', 'Clamp', 'Crab Hammer'),
(504, 'Patrat', 55, 35, 39, 39, 45, 42, 'Watchog', 20, 'Normal', NULL, 100, 504, 'Pay Day', 'Egg Bomb', 'Mega Kick', 'Self Destruct'),
(505, 'Watchog', 85, 60, 69, 69, 60, 77, NULL, NULL, 'Normal', NULL, 100, 505, 'Thrash', 'Bind', 'Self Destruct', 'Struggle'),
(506, 'Lillipup', 60, 25, 45, 45, 45, 55, 'Herdier', NULL, 'Normal', NULL, 100, 506, 'Vice Grip', 'Dizzy Punch', 'Fury Attack', 'Strength'),
(507, 'Herdier', 80, 35, 65, 65, 65, 60, 'Stoutland', NULL, 'Normal', NULL, 100, 507, 'Comet Punch', 'Horn Attack', 'Fury Swipes', 'Pay Day'),
(508, 'Stoutland', 100, 45, 90, 90, 85, 80, NULL, NULL, 'Normal', NULL, 100, 508, 'Skull Bash', 'Bind', 'Comet Punch', 'Constrict'),
(509, 'Purrloin', 50, 50, 37, 37, 41, 66, 'Liepard', NULL, 'Dark', NULL, 100, 509, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(510, 'Liepard', 88, 88, 50, 50, 64, 106, NULL, NULL, 'Dark', NULL, 100, 510, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(511, 'Pansage', 53, 53, 48, 48, 50, 64, 'Simisage', NULL, 'Grass', NULL, 100, 511, 'Vine Whip', 'Petal Dance', 'Absorb', 'Mega Drain'),
(512, 'Simisage', 98, 98, 63, 63, 75, 101, NULL, NULL, 'Grass', NULL, 100, 512, 'Mega Drain', 'Mega Drain', 'Petal Dance', 'Vine Whip'),
(513, 'Pansear', 53, 53, 48, 48, 50, 64, 'Simisear', NULL, 'Fire', NULL, 100, 513, 'Ember', 'Ember', 'Fire Punch', 'Fire Punch'),
(514, 'Simisear', 98, 98, 63, 63, 75, 101, NULL, NULL, 'Fire', NULL, 100, 514, 'Fire Punch', 'Flamethrower', 'Fire Spin', 'Fire Punch'),
(515, 'Panpour', 53, 53, 48, 48, 50, 64, 'Simipour', NULL, 'Water', NULL, 100, 515, 'Surf', 'Waterfall', 'Bubblebeam', 'Clamp'),
(516, 'Simipour', 98, 98, 63, 63, 75, 101, NULL, NULL, 'Water', NULL, 100, 516, 'Crab Hammer', 'Clamp', 'Surf', 'Surf'),
(517, 'Munna', 25, 67, 45, 55, 76, 24, 'Musharna', NULL, 'Psychic', NULL, 100, 517, 'Confusion', 'Confusion', 'Psychic', 'Dream Eater'),
(518, 'Musharna', 55, 107, 85, 95, 116, 29, NULL, NULL, 'Psychic', NULL, 100, 518, 'Dream Eater', 'Psychic', 'Confusion', 'Psychic'),
(519, 'Pidove', 55, 36, 50, 30, 50, 43, 'Tranquill', NULL, 'Normal', 'Flying', 100, 519, 'Vice Grip', 'Thrash', 'Gust', 'Wing Attack'),
(520, 'Tranquill', 77, 50, 62, 42, 62, 65, 'Unfezant', NULL, 'Normal', 'Flying', 100, 520, 'Skull Bash', 'Cut', 'Gust', 'Peck'),
(521, 'Unfezant', 105, 65, 80, 55, 80, 93, NULL, NULL, 'Normal', 'Flying', 100, 521, 'Slam', 'Quick Attack', 'Wing Attack', 'Sky Attack'),
(522, 'Blitzle', 60, 50, 32, 32, 45, 76, 'Zebstrika', NULL, 'Electric', NULL, 100, 522, 'Thunder Punch', 'Thundershock', 'Thunder', 'Thunder Punch'),
(523, 'Zebstrika', 100, 80, 63, 63, 75, 116, NULL, NULL, 'Electric', NULL, 100, 523, 'Thunderbolt', 'Thunderbolt', 'Thunder', 'Thunderbolt'),
(524, 'Roggenrola', 75, 25, 85, 25, 55, 15, 'Boldore', NULL, 'Rock', NULL, 100, 524, 'Rock Throw', 'Rock Throw', 'Rock Slide', 'Rock Throw'),
(525, 'Boldore', 105, 50, 105, 40, 70, 20, 'Gigalith', NULL, 'Rock', NULL, 100, 525, 'Rock Slide', 'Rock Throw', 'Rock Slide', 'Rock Slide'),
(526, 'Gigalith', 135, 60, 130, 70, 85, 25, NULL, NULL, 'Rock', NULL, 100, 526, 'Rock Throw', 'Rock Slide', 'Rock Slide', 'Rock Slide'),
(527, 'Woobat', 45, 55, 43, 43, 55, 72, 'Swoobat', NULL, 'Psychic', 'Flying', 100, 527, 'Psybeam', 'Confusion', 'Fly', 'Fly'),
(528, 'Swoobat', 57, 77, 55, 55, 67, 114, NULL, NULL, 'Psychic', 'Flying', 100, 528, 'Psychic', 'Psychic', 'Gust', 'Gust'),
(529, 'Drilbur', 85, 30, 40, 45, 60, 68, 'Excadrill', NULL, 'Ground', NULL, 100, 529, 'Bonemerang', 'Bonemerang', 'Bonemerang', 'Bone Club'),
(530, 'Excadrill', 135, 50, 60, 65, 110, 88, NULL, NULL, 'Ground', 'Steel', 100, 530, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(531, 'Audino', 60, 60, 86, 86, 103, 50, NULL, NULL, 'Normal', NULL, 100, 531, 'Slam', 'Explosion', 'Mega Kick', 'Vice Grip'),
(532, 'Timburr', 80, 25, 55, 35, 75, 35, 'Gurdurr', NULL, 'Fighting', NULL, 100, 532, 'Karate Chop', 'Submission', 'Submission', 'Double Kick'),
(533, 'Gurdurr', 105, 40, 85, 50, 85, 40, 'Conkeldurr', NULL, 'Fighting', NULL, 100, 533, 'Submission', 'Double Kick', 'Rolling Kick', 'Jump Kick'),
(534, 'Conkeldurr', 140, 55, 95, 65, 105, 45, NULL, NULL, 'Fighting', NULL, 100, 534, 'Submission', 'Double Kick', 'Jump Kick', 'Jump Kick'),
(535, 'Tympole', 50, 50, 40, 40, 50, 64, 'Palpitoad', NULL, 'Water', NULL, 100, 535, 'Bubble', 'Hydro Pump', 'Bubblebeam', 'Hydro Pump'),
(536, 'Palpitoad', 65, 65, 55, 55, 75, 69, 'Seismitoad', NULL, 'Water', 'Ground', 100, 536, 'Bubblebeam', 'Crab Hammer', 'Dig', 'Earthquake'),
(537, 'Seismitoad', 85, 85, 75, 75, 105, 74, NULL, NULL, 'Water', 'Ground', 100, 537, 'Waterfall', 'Bubble', 'Dig', 'Bonemerang'),
(538, 'Throh', 100, 30, 85, 85, 120, 45, NULL, NULL, 'Fighting', NULL, 100, 538, 'Double Kick', 'Double Kick', 'Jump Kick', 'Submission'),
(539, 'Sawk', 125, 30, 75, 75, 75, 85, NULL, NULL, 'Fighting', NULL, 100, 539, 'Karate Chop', 'Double Kick', 'Rolling Kick', 'Rolling Kick'),
(540, 'Sewaddle', 53, 40, 70, 60, 45, 42, 'Swadloon', NULL, 'Bug', 'Grass', 100, 540, 'Pin Missile', 'Leech Life', 'Absorb', 'Vine Whip'),
(541, 'Swadloon', 63, 50, 90, 80, 55, 42, 'Leavanny', NULL, 'Bug', 'Grass', 100, 541, 'Pin Missile', 'Leech Life', 'Petal Dance', 'Vine Whip'),
(542, 'Leavanny', 103, 70, 80, 70, 75, 92, NULL, NULL, 'Bug', 'Grass', 100, 542, 'Leech Life', 'Twineedle', 'Absorb', 'Vine Whip'),
(543, 'Venipede', 45, 30, 59, 39, 30, 57, 'Whirlipede', NULL, 'Bug', 'Poison', 100, 543, 'Leech Life', 'Twineedle', 'Acid', 'Poison Sting'),
(544, 'Whirlipede', 55, 40, 99, 79, 40, 47, 'Scolipede', NULL, 'Bug', 'Poison', 100, 544, 'Pin Missile', 'Twineedle', 'Poison Sting', 'Sludge'),
(545, 'Scolipede', 90, 55, 89, 69, 60, 112, NULL, NULL, 'Bug', 'Poison', 100, 545, 'Twineedle', 'Twineedle', 'Poison Sting', 'Sludge'),
(546, 'Cottonee', 27, 37, 60, 50, 40, 66, 'Whimsicott', NULL, 'Grass', NULL, 100, 546, 'Vine Whip', 'Vine Whip', 'Mega Drain', 'Absorb'),
(547, 'Whimsicott', 67, 77, 85, 75, 60, 116, NULL, NULL, 'Grass', NULL, 100, 547, 'Absorb', 'Vine Whip', 'Absorb', 'Mega Drain'),
(548, 'Petilil', 35, 70, 50, 50, 45, 30, 'Lilligant', NULL, 'Grass', NULL, 100, 548, 'Mega Drain', 'Mega Drain', 'Solar Beam', 'Solar Beam'),
(549, 'Lilligant', 60, 110, 75, 75, 70, 90, NULL, NULL, 'Grass', NULL, 100, 549, 'Solar Beam', 'Absorb', 'Solar Beam', 'Razor Leaf'),
(550, 'Basculin', 92, 80, 65, 55, 70, 98, NULL, NULL, 'Water', NULL, 100, 550, 'Waterfall', 'Hydro Pump', 'Clamp', 'Clamp'),
(551, 'Sandile', 72, 35, 35, 35, 50, 65, 'Krokorok', NULL, 'Ground', 'Dark', 100, 551, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(552, 'Krokorok', 82, 45, 45, 45, 60, 74, 'Krookodile', NULL, 'Ground', 'Dark', 100, 552, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(553, 'Krookodile', 117, 65, 70, 70, 95, 92, NULL, NULL, 'Ground', 'Dark', 100, 553, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(554, 'Darumaka', 90, 15, 45, 45, 70, 50, 'Darmanitan', NULL, 'Fire', NULL, 100, 554, 'Flamethrower', 'Fire Punch', 'Fire Spin', 'Fire Punch'),
(555, 'Darmanitan', 140, 30, 55, 55, 105, 95, NULL, NULL, 'Fire', NULL, 100, 555, 'Fire Blast', 'Fire Blast', 'Fire Punch', 'Fire Spin'),
(556, 'Maractus', 86, 106, 67, 67, 75, 60, NULL, NULL, 'Grass', NULL, 100, 556, 'Solar Beam', 'Petal Dance', 'Solar Beam', 'Mega Drain'),
(557, 'Dwebble', 65, 35, 85, 35, 50, 55, 'Crustle', NULL, 'Bug', 'Rock', 100, 557, 'Pin Missile', 'Twineedle', 'Rock Slide', 'Rock Throw'),
(558, 'Crustle', 95, 65, 125, 75, 70, 45, NULL, NULL, 'Bug', 'Rock', 100, 558, 'Pin Missile', 'Pin Missile', 'Rock Throw', 'Rock Slide'),
(559, 'Scraggy', 75, 35, 70, 70, 50, 45, 'Scrafty', NULL, 'Dark', 'Fighting', 100, 559, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(560, 'Scrafty', 90, 45, 115, 115, 65, 58, NULL, NULL, 'Dark', 'Fighting', 100, 560, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(561, 'Sigilyph', 58, 103, 80, 80, 72, 97, NULL, NULL, 'Psychic', 'Fighting', 100, 561, 'Psybeam', 'Psybeam', 'Double Kick', 'Rolling Kick'),
(562, 'Yamask', 30, 55, 85, 65, 38, 30, 'Cofagrigus', NULL, 'Ghost', NULL, 100, 562, 'Shadow Armlet', 'Lick', 'Lick', 'Shadow Armlet'),
(563, 'Cofagrigus', 50, 95, 145, 105, 58, 30, NULL, NULL, 'Ghost', NULL, 100, 563, 'Lick', 'Shadow Armlet', 'Lick', 'Lick'),
(564, 'Tirtouga', 78, 53, 103, 45, 54, 22, 'Carracosta', NULL, 'Water', 'Rock', 100, 564, 'Crab Hammer', 'Clamp', 'Rock Slide', 'Rock Throw'),
(565, 'Carracosta', 108, 83, 133, 65, 74, 32, NULL, NULL, 'Water', 'Rock', 100, 565, 'Clamp', 'Clamp', 'Rock Throw', 'Rock Throw'),
(566, 'Archen', 112, 74, 45, 45, 55, 70, 'Archeops', NULL, 'Rock', 'Flying', 100, 566, 'Rock Throw', 'Rock Slide', 'Sky Attack', 'Wing Attack'),
(567, 'Archeops', 140, 112, 65, 65, 75, 110, NULL, NULL, 'Rock', 'Flying', 100, 567, 'Rock Throw', 'Rock Throw', 'Peck', 'Wing Attack'),
(568, 'Trubbish', 50, 40, 62, 62, 50, 65, 'Garbodor', NULL, 'Poison', NULL, 100, 568, 'Acid', 'Smog', 'Smog', 'Smog'),
(569, 'Garbodor', 95, 60, 82, 82, 80, 75, NULL, NULL, 'Poison', NULL, 100, 569, 'Acid', 'Sludge', 'Acid', 'Smog'),
(570, 'Zorua', 65, 80, 40, 40, 40, 65, 'Zoroark', NULL, 'Dark', NULL, 100, 570, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(571, 'Zoroark', 105, 120, 60, 60, 60, 105, NULL, NULL, 'Dark', NULL, 100, 571, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(572, 'Minccino', 50, 40, 40, 40, 55, 75, 'Cinccino', NULL, 'Normal', NULL, 100, 572, 'Slash', 'Take Down', 'Swift', 'Vice Grip'),
(573, 'Cinccino', 95, 65, 60, 60, 75, 115, NULL, NULL, 'Normal', NULL, 100, 573, 'Cut', 'Strength', 'Scratch', 'Fury Swipes'),
(574, 'Gothita', 30, 55, 50, 65, 45, 45, 'Gothorita', NULL, 'Psychic', NULL, 100, 574, 'Confusion', 'Psychic', 'Confusion', 'Psychic'),
(575, 'Gothorita', 45, 75, 70, 85, 60, 55, 'Gothitelle', NULL, 'Psychic', NULL, 100, 575, 'Confusion', 'Dream Eater', 'Psybeam', 'Psybeam'),
(576, 'Gothitelle', 55, 95, 95, 110, 70, 65, NULL, NULL, 'Psychic', NULL, 100, 576, 'Psychic', 'Confusion', 'Psybeam', 'Confusion'),
(577, 'Solosis', 30, 105, 40, 50, 45, 20, 'Duosion', NULL, 'Psychic', NULL, 100, 577, 'Psybeam', 'Psybeam', 'Dream Eater', 'Psychic'),
(578, 'Duosion', 40, 125, 50, 60, 65, 30, 'Reuniclus', NULL, 'Psychic', NULL, 100, 578, 'Confusion', 'Psybeam', 'Psychic', 'Confusion'),
(579, 'Reuniclus', 65, 125, 75, 85, 110, 30, NULL, NULL, 'Psychic', NULL, 100, 579, 'Psychic', 'Psybeam', 'Confusion', 'Dream Eater'),
(580, 'Ducklett', 44, 44, 50, 50, 62, 65, 'Swanna', NULL, 'Water', 'Flying', 100, 580, 'Hydro Pump', 'Crab Hammer', 'Wing Attack', 'Fly'),
(581, 'Swanna', 87, 87, 63, 63, 75, 98, NULL, NULL, 'Water', 'Flying', 100, 581, 'Crab Hammer', 'Waterfall', 'Fly', 'Fly'),
(582, 'Vanillite', 50, 65, 50, 60, 36, 44, 'Vanillish', NULL, 'Ice', NULL, 100, 582, 'Aurora Beam', 'Blizzard', 'Ice Punch', 'Aurora Beam'),
(583, 'Vanillish', 65, 80, 65, 75, 51, 59, 'Vanilluxe', NULL, 'Ice', NULL, 100, 583, 'Blizzard', 'Ice Punch', 'Ice Punch', 'Ice Punch'),
(584, 'Vanilluxe', 95, 110, 85, 95, 71, 79, NULL, NULL, 'Ice', NULL, 100, 584, 'Aurora Beam', 'Blizzard', 'Ice Beam', 'Ice Beam'),
(585, 'Deerling', 60, 40, 50, 50, 60, 75, 'Sawsbuck', NULL, 'Normal', 'Grass', 100, 585, 'Swift', 'Hyper Beam', 'Mega Drain', 'Mega Drain'),
(586, 'Sawsbuck', 100, 60, 70, 70, 80, 95, NULL, NULL, 'Normal', 'Grass', 100, 586, 'Comet Punch', 'Body Slam', 'Petal Dance', 'Petal Dance'),
(587, 'Emolga', 75, 75, 60, 60, 55, 103, NULL, NULL, 'Electric', 'Flying', 100, 587, 'Thundershock', 'Thunder Punch', 'Drill Peck', 'Sky Attack'),
(588, 'Karrablast', 75, 40, 45, 45, 50, 60, 'Escavalier', NULL, 'Bug', NULL, 100, 588, 'Twineedle', 'Pin Missile', 'Pin Missile', 'Pin Missile'),
(589, 'Escavalier', 135, 60, 105, 105, 70, 20, NULL, NULL, 'Bug', 'Steel', 100, 589, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(590, 'Foongus', 55, 55, 45, 55, 69, 15, 'Amoonguss', NULL, 'Grass', 'Poison', 100, 590, 'Mega Drain', 'Mega Drain', 'Acid', 'Sludge'),
(591, 'Amoonguss', 85, 85, 70, 80, 114, 30, NULL, NULL, 'Grass', 'Poison', 100, 591, 'Razor Leaf', 'Solar Beam', 'Smog', 'Acid'),
(592, 'Frillish', 40, 65, 50, 85, 55, 40, 'Jellicent', NULL, 'Water', 'Ghost', 100, 592, 'Bubble', 'Bubblebeam', 'Shadow Armlet', 'Lick'),
(593, 'Jellicent', 60, 85, 70, 105, 100, 60, NULL, NULL, 'Water', 'Ghost', 100, 593, 'Clamp', 'Clamp', 'Lick', 'Lick'),
(594, 'Alomomola', 75, 40, 80, 45, 165, 65, NULL, NULL, 'Water', NULL, 100, 594, 'Waterfall', 'Waterfall', 'Surf', 'Crab Hammer'),
(595, 'Joltik', 47, 57, 50, 50, 50, 65, 'Galvantula', NULL, 'Bug', 'Electric', 100, 595, 'Leech Life', 'Pin Missile', 'Thunder Punch', 'Thunderbolt'),
(596, 'Galvantula', 77, 97, 60, 60, 70, 108, NULL, NULL, 'Bug', 'Electric', 100, 596, 'Twineedle', 'Pin Missile', 'Thunder Punch', 'Thunder Punch'),
(597, 'Ferroseed', 50, 24, 91, 86, 44, 10, 'Ferrothorn', NULL, 'Grass', 'Steel', 100, 597, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(598, 'Ferrothorn', 94, 54, 131, 116, 74, 20, NULL, NULL, 'Grass', 'Steel', 100, 598, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(599, 'Klink', 55, 45, 70, 60, 40, 30, 'Klang', NULL, 'Steel', NULL, 100, 599, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(600, 'Klang', 80, 70, 95, 85, 60, 50, 'Klinklang', NULL, 'Steel', NULL, 100, 600, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(601, 'Klinklang', 100, 70, 115, 85, 60, 90, NULL, NULL, 'Steel', NULL, 100, 601, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(602, 'Tynamo', 55, 45, 40, 40, 35, 60, 'Eelektrik', NULL, 'Electric', NULL, 100, 602, 'Thunder Punch', 'Thunder', 'Thunder Punch', 'Thunder Punch'),
(603, 'Eelektrik', 85, 75, 70, 70, 65, 40, 'Eelektross', NULL, 'Electric', NULL, 100, 603, 'Thunderbolt', 'Thunderbolt', 'Thundershock', 'Thunder Punch'),
(604, 'Eelektross', 115, 105, 80, 80, 85, 50, NULL, NULL, 'Electric', NULL, 100, 604, 'Thundershock', 'Thunder', 'Thunder Punch', 'Thunder'),
(605, 'Elgyem', 55, 85, 55, 55, 55, 30, 'Beheeyem', NULL, 'Psychic', NULL, 100, 605, 'Psychic', 'Dream Eater', 'Dream Eater', 'Confusion'),
(606, 'Beheeyem', 75, 125, 75, 95, 75, 40, NULL, NULL, 'Psychic', NULL, 100, 606, 'Dream Eater', 'Psychic', 'Psybeam', 'Psychic'),
(607, 'Litwick', 30, 65, 55, 55, 50, 20, 'Lampent', NULL, 'Ghost', 'Fire', 100, 607, 'Shadow Armlet', 'Lick', 'Fire Punch', 'Fire Punch'),
(608, 'Lampent', 40, 95, 60, 60, 60, 55, 'Chandelure', NULL, 'Ghost', 'Fire', 100, 608, 'Shadow Armlet', 'Lick', 'Fire Spin', 'Fire Blast'),
(609, 'Chandelure', 55, 145, 90, 90, 60, 80, NULL, NULL, 'Ghost', 'Fire', 100, 609, 'Lick', 'Shadow Armlet', 'Flamethrower', 'Fire Punch'),
(610, 'Axew', 87, 30, 60, 40, 46, 57, 'Fraxure', NULL, 'Dragon', NULL, 100, 610, 'Dragon Rage', 'Dragon Rage', 'Dragon Rage', 'Dragon Rage'),
(611, 'Fraxure', 117, 40, 70, 50, 66, 67, 'Haxorus', NULL, 'Dragon', NULL, 100, 611, 'Dragon Rage', 'Dragon Rage', 'Dragon Rage', 'Dragon Rage'),
(612, 'Haxorus', 147, 60, 90, 70, 76, 97, NULL, NULL, 'Dragon', NULL, 100, 612, 'Dragon Rage', 'Dragon Rage', 'Dragon Rage', 'Dragon Rage'),
(613, 'Cubchoo', 70, 60, 40, 40, 55, 40, 'Beartic', NULL, 'Ice', NULL, 100, 613, 'Ice Punch', 'Ice Punch', 'Aurora Beam', 'Ice Beam'),
(614, 'Beartic', 110, 70, 80, 80, 95, 50, 'Cryogonal', NULL, 'Ice', NULL, 100, 614, 'Ice Punch', 'Aurora Beam', 'Blizzard', 'Blizzard'),
(615, 'Cryogonal', 50, 95, 30, 135, 70, 105, NULL, NULL, 'Ice', NULL, 100, 615, 'Ice Beam', 'Ice Punch', 'Ice Punch', 'Blizzard'),
(616, 'Shelmet', 40, 40, 85, 65, 50, 25, 'Accelgor', NULL, 'Bug', NULL, 100, 616, 'Leech Life', 'Pin Missile', 'Twineedle', 'Twineedle'),
(617, 'Accelgor', 70, 100, 40, 60, 80, 145, NULL, NULL, 'Bug', NULL, 100, 617, 'Pin Missile', 'Twineedle', 'Twineedle', 'Leech Life'),
(618, 'Stunfisk', 66, 81, 84, 99, 109, 32, NULL, NULL, 'Electric', 'Ground', 100, 618, 'Thunderbolt', 'Thundershock', 'Dig', 'Bone Club'),
(619, 'Mienfoo', 85, 55, 50, 50, 45, 65, 'Mienshao', NULL, 'Fighting', NULL, 100, 619, 'Double Kick', 'Submission', 'Double Kick', 'Jump Kick'),
(620, 'Mienshao', 125, 95, 60, 60, 65, 105, NULL, NULL, 'Fighting', NULL, 100, 620, 'Double Kick', 'Karate Chop', 'Submission', 'Karate Chop'),
(621, 'Druddigon', 120, 60, 90, 90, 77, 48, NULL, NULL, 'Dragon', NULL, 100, 621, 'Dragon Rage', 'Dragon Rage', 'Dragon Rage', 'Dragon Rage'),
(622, 'Golett', 74, 35, 50, 50, 59, 35, 'Golurk', NULL, 'Ground', 'Ghost', 100, 622, 'Bonemerang', 'Bonemerang', 'Lick', 'Shadow Armlet'),
(623, 'Golurk', 124, 55, 80, 80, 89, 55, NULL, NULL, 'Ground', 'Ghost', 100, 623, 'Bonemerang', 'Dig', 'Lick', 'Shadow Armlet'),
(624, 'Pawniard', 85, 40, 70, 40, 45, 60, 'Bisharp', NULL, 'Dark', 'Steel', 100, 624, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(625, 'Bisharp', 125, 60, 100, 70, 65, 70, NULL, NULL, 'Dark', 'Steel', 100, 625, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(626, 'Bouffalant', 110, 40, 95, 95, 95, 55, NULL, NULL, 'Normal', NULL, 100, 626, 'Doubleslap', 'Slam', 'Swift', 'Take Down'),
(627, 'Rufflet', 83, 37, 50, 50, 70, 60, 'Braviary', NULL, 'Normal', 'Flying', 100, 627, 'Tri Attack', 'Hyper Beam', 'Peck', 'Sky Attack'),
(628, 'Braviary', 123, 57, 75, 75, 100, 80, NULL, NULL, 'Normal', 'Flying', 100, 628, 'Tackle', 'Pound', 'Gust', 'Gust'),
(629, 'Vullaby', 55, 45, 75, 65, 70, 60, 'Mandibuzz', NULL, 'DarK', 'Flying', 100, 629, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(630, 'Mandibuzz', 65, 55, 105, 95, 110, 80, NULL, NULL, 'Dark', 'Flying', 100, 630, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(631, 'Heatmor', 97, 105, 66, 66, 85, 65, NULL, NULL, 'Fire', NULL, 100, 631, 'Fire Blast', 'Ember', 'Fire Punch', 'Fire Spin'),
(632, 'Durant', 109, 48, 112, 48, 58, 109, NULL, NULL, 'Bug', 'Steel', 100, 632, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(633, 'Deino', 65, 45, 50, 50, 52, 38, 'Zweilous', NULL, 'Dark', 'Dragon', 100, 633, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(634, 'Zweilous', 85, 65, 70, 70, 72, 58, 'Hydreigon', NULL, 'Dark', 'Dragon', 100, 634, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(635, 'Hydreigon', 105, 125, 90, 90, 92, 98, NULL, NULL, 'Dark', 'Dragon', 100, 635, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(636, 'Larvesta', 85, 50, 55, 55, 55, 60, 'Volcarona', NULL, 'Bug', 'Fire', 100, 636, 'Pin Missile', 'Pin Missile', 'Ember', 'Fire Punch'),
(637, 'Volcarona', 60, 135, 65, 105, 85, 100, NULL, NULL, 'Bug', 'Fire', 100, 637, 'Twineedle', 'Leech Life', 'Fire Blast', 'Fire Spin'),
(638, 'Cobalion', 90, 90, 129, 72, 91, 108, NULL, NULL, 'Steel', 'Fighting', 100, 638, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(639, 'Terrakion', 129, 72, 90, 90, 91, 108, NULL, NULL, 'Rock', 'Fighting', 100, 639, 'Rock Slide', 'Rock Slide', 'Jump Kick', 'Double Kick'),
(640, 'Virizion', 90, 90, 72, 129, 91, 108, NULL, NULL, 'Grass', 'Fighting', 100, 640, 'Mega Drain', 'Petal Dance', 'Jump Kick', 'Jump Kick'),
(641, 'Tornadus', 115, 125, 70, 80, 79, 111, NULL, NULL, 'Flying', NULL, 100, 641, 'Peck', 'Drill Peck', 'Drill Peck', 'Wing Attack'),
(642, 'Thundurus', 115, 125, 70, 80, 79, 111, NULL, NULL, 'Electric', 'Flying', 100, 642, 'Thunder', 'Thundershock', 'Wing Attack', 'Fly'),
(643, 'Reshiram', 120, 150, 100, 120, 100, 90, NULL, NULL, 'Dragon', 'Fire', 100, 643, 'Dragon Rage', 'Dragon Rage', 'Fire Spin', 'Fire Spin'),
(644, 'Zekrom', 150, 120, 120, 100, 100, 90, NULL, NULL, 'Dragon', 'Electric', 100, 644, 'Dragon Rage', 'Dragon Rage', 'Thunderbolt', 'Thunder'),
(645, 'Landorus', 125, 115, 90, 80, 89, 101, NULL, NULL, 'Ground', 'Flying', 100, 645, 'Earthquake', 'Bonemerang', 'Gust', 'Fly'),
(646, 'Kyurem', 130, 130, 90, 90, 125, 95, NULL, NULL, 'Dragon', 'Ice', 100, 646, 'Dragon Rage', 'Dragon Rage', 'Ice Beam', 'Ice Punch'),
(647, 'Keldeo', 72, 129, 90, 90, 91, 108, NULL, NULL, 'Water', 'Fighting', 100, 647, 'Water Gun', 'Surf', 'Rolling Kick', 'Karate Chop'),
(648, 'Meloetta', 77, 128, 77, 128, 100, 90, NULL, NULL, 'Normal', 'Psychic', 100, 648, 'Comet Punch', 'Skull Bash', 'Confusion', 'Confusion'),
(649, 'Genesect', 120, 120, 95, 95, 71, 99, NULL, NULL, 'Bug', 'Steel', 100, 649, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(5095, 'Gyarados (A)', 100, 100, 100, 100, 100, 100, 'none', NULL, 'Water', '', 64, 130, 'Water Gun', 'Hydro Pump', 'Bubble', 'Bubble'),
(5094, 'Gyarados (M)', 100, 100, 100, 100, 100, 100, 'none', NULL, 'Water', '', 64, 130, 'Waterfall', 'Clamp', 'Bubble', 'Hydro Pump'),
(5093, 'Gyarados (Z)', 100, 100, 100, 100, 100, 100, 'none', NULL, 'Water', 'Flying', 64, 130, 'Hydro Pump', 'Bubblebeam', 'Fly', 'Drill Peck'),
(5106, 'Angleos', 150, 155, 150, 155, 142, 144, 'none', NULL, 'Normal', 'Psychic', 64, 5001, 'Shadow Armlet', 'Shadow Armlet', 'Shadow Armlet', 'Shadow Armlet'),
(5112, 'Charizard (X)', 100, 100, 100, 100, 100, 100, NULL, 0, 'Fire', 'Flying', 209, 6, 'Fire Blast', 'Body Slam', 'Bite', 'Focus Energy'),
(5113, 'Charizard (Y)', 100, 100, 100, 100, 100, 100, NULL, 0, 'Fire', 'Flying', 209, 6, 'Fire Blast', 'Explosion', 'Shadow Armlet', 'Comet Punch'),
(5114, 'Deoxys (Attack)', 180, 180, 20, 20, 50, 150, NULL, NULL, 'Psychic', NULL, 215, 386, 'Confusion', 'Confusion', 'Psybeam', 'Psychic'),
(5115, 'Deoxys (Defence)', 70, 180, 160, 160, 50, 90, NULL, NULL, 'Psychic', NULL, 215, 386, 'Psybeam', 'Psybeam', 'Dream Eater', 'Psybeam'),
(5116, 'Deoxys (Speed)', 95, 95, 90, 90, 50, 180, NULL, NULL, 'Psychic', NULL, 215, 386, 'Psychic', 'Psybeam', 'Psychic', 'Psychic'),
(5136, 'Arceus (Unknown)', 120, 120, 120, 120, 120, 120, NULL, NULL, 'Unknown', NULL, 255, 493, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(5118, 'Arceus (Ground)', 120, 120, 120, 120, 120, 120, NULL, NULL, 'Ground', NULL, 255, 493, 'Dig', 'Dig', 'Bonemerang', 'Earthquake'),
(5119, 'Arceus (Fire)', 120, 120, 120, 120, 120, 120, NULL, NULL, 'Fire', NULL, 255, 493, 'Fire Punch', 'Ember', 'Flamethrower', 'Fire Blast'),
(5120, 'Arceus (Water)', 120, 120, 120, 120, 120, 120, NULL, NULL, 'Water', NULL, 255, 493, 'Hydro Pump', 'Surf', 'Surf', 'Surf'),
(5121, 'Arceus (Electric)', 120, 120, 120, 120, 120, 120, NULL, NULL, 'Electric', NULL, 255, 493, 'Thundershock', 'Thunder Punch', 'Thunder', 'Thundershock'),
(5122, 'Arceus (Grass)', 120, 120, 120, 120, 120, 120, NULL, NULL, 'Grass', NULL, 255, 493, 'Mega Drain', 'Vine Whip', 'Absorb', 'Razor Leaf'),
(5123, 'Arceus (Ice)', 120, 120, 120, 120, 120, 120, NULL, NULL, 'Ice', NULL, 255, 493, 'Blizzard', 'Aurora Beam', 'Ice Beam', 'Ice Beam'),
(5124, 'Arceus (Fighting)', 120, 120, 120, 120, 120, 120, NULL, NULL, 'Fighting', NULL, 255, 493, 'Rolling Kick', 'Rolling Kick', 'Karate Chop', 'Double Kick'),
(5125, 'Arceus (Poison)', 120, 120, 120, 120, 120, 120, NULL, NULL, 'Poison', NULL, 255, 493, 'Poison Sting', 'Smog', 'Poison Sting', 'Smog'),
(5126, 'Arceus (Flying)', 120, 120, 120, 120, 120, 120, NULL, NULL, 'Flying', NULL, 255, 493, 'Gust', 'Peck', 'Peck', 'Peck'),
(5127, 'Arceus (Psychic)', 120, 120, 120, 120, 120, 120, NULL, NULL, 'Psychic', NULL, 255, 493, 'Dream Eater', 'Psychic', 'Psybeam', 'Psybeam'),
(5128, 'Arceus (Bug)', 120, 120, 120, 120, 120, 120, NULL, NULL, 'Bug', NULL, 255, 493, 'Leech Life', 'Leech Life', 'Leech Life', 'Twineedle'),
(5129, 'Arceus (Rock)', 120, 120, 120, 120, 120, 120, NULL, NULL, 'Rock', NULL, 255, 493, 'Rock Throw', 'Rock Slide', 'Rock Throw', 'Rock Slide'),
(5130, 'Arceus (Ghost)', 120, 120, 120, 120, 120, 120, NULL, NULL, 'Ghost', NULL, 255, 493, 'Shadow Armlet', 'Lick', 'Shadow Armlet', 'Shadow Armlet'),
(5131, 'Arceus (Dragon)', 120, 120, 120, 120, 120, 120, NULL, NULL, 'Dragon', NULL, 255, 493, 'Dragon Rage', 'Dragon Rage', 'Dragon Rage', 'Dragon Rage'),
(5132, 'Arceus (Dark)', 120, 120, 120, 120, 120, 120, NULL, NULL, 'Dark', NULL, 255, 493, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(5133, 'Arceus (Steel)', 120, 120, 120, 120, 120, 120, NULL, NULL, 'Steel', NULL, 255, 493, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(5135, 'Giratina (Origin)', 100, 100, 120, 120, 150, 90, NULL, NULL, 'Ghost', 'Dragon', 220, 486, 'Shadow Armlet', 'Blizzard', 'Hydro Pump', 'Hyper Beam'),
(5137, 'Absol (Mega)', 150, 150, 100, 100, 100, 100, NULL, NULL, 'Dark', NULL, 174, 359, 'Hyper Beam', 'Bite', 'Bite', 'Bite'),
(5139, 'Eevhoom', 100, 100, 100, 100, 100, 100, 'none', NULL, 'Dark', '', 0, 5000, 'Absorb', 'Absorb', 'Absorb', 'Absorb'),
(5140, 'Unown (Em)', 72, 72, 48, 48, 48, 48, NULL, NULL, 'Psychic', NULL, 61, 201, 'Confusion', 'Psybeam', 'Confusion', 'Dream Eater'),
(5141, 'Unown (A)', 72, 72, 48, 48, 48, 48, NULL, NULL, 'Psychic', NULL, 61, 201, 'Dream Eater', 'Psychic', 'Dream Eater', 'Confusion'),
(5142, 'Unown (B)', 72, 72, 48, 48, 48, 48, NULL, NULL, 'Psychic', NULL, 61, 201, 'Dream Eater', 'Confusion', 'Psychic', 'Psychic'),
(5143, 'Unown (C)', 72, 72, 48, 48, 48, 48, NULL, NULL, 'Psychic', NULL, 61, 201, 'Psybeam', 'Psychic', 'Psybeam', 'Dream Eater'),
(5144, 'Unown (D)', 72, 72, 48, 48, 48, 48, NULL, NULL, 'Psychic', NULL, 61, 201, 'Dream Eater', 'Confusion', 'Psychic', 'Confusion'),
(5145, 'Unown (E)', 72, 72, 48, 48, 48, 48, NULL, NULL, 'Psychic', NULL, 61, 201, 'Psybeam', 'Dream Eater', 'Psybeam', 'Psychic'),
(5146, 'Unown (F)', 72, 72, 48, 48, 48, 48, NULL, NULL, 'Psychic', NULL, 61, 201, 'Confusion', 'Confusion', 'Dream Eater', 'Psychic'),
(5147, 'Unown (G)', 72, 72, 48, 48, 48, 48, NULL, NULL, 'Psychic', NULL, 61, 201, 'Dream Eater', 'Dream Eater', 'Psychic', 'Dream Eater'),
(5148, 'Unown (H)', 72, 72, 48, 48, 48, 48, NULL, NULL, 'Psychic', NULL, 61, 201, 'Psybeam', 'Psybeam', 'Psychic', 'Psychic'),
(5149, 'Unown (I)', 72, 72, 48, 48, 48, 48, NULL, NULL, 'Psychic', NULL, 61, 201, 'Dream Eater', 'Dream Eater', 'Confusion', 'Psybeam'),
(5150, 'Unown (J)', 72, 72, 48, 48, 48, 48, NULL, NULL, 'Psychic', NULL, 61, 201, 'Psychic', 'Dream Eater', 'Dream Eater', 'Psychic'),
(5151, 'Unown (K)', 72, 72, 48, 48, 48, 48, NULL, NULL, 'Psychic', NULL, 61, 201, 'Dream Eater', 'Dream Eater', 'Confusion', 'Dream Eater'),
(5152, 'Unown (L)', 72, 72, 48, 48, 48, 48, NULL, NULL, 'Psychic', NULL, 61, 201, 'Psychic', 'Psychic', 'Dream Eater', 'Dream Eater'),
(5153, 'Unown (M)', 72, 72, 48, 48, 48, 48, NULL, NULL, 'Psychic', NULL, 61, 201, 'Confusion', 'Psychic', 'Confusion', 'Dream Eater'),
(5154, 'Unown (N)', 72, 72, 48, 48, 48, 48, NULL, NULL, 'Psychic', NULL, 61, 201, 'Dream Eater', 'Psychic', 'Psybeam', 'Psychic'),
(5155, 'Unown (O)', 72, 72, 48, 48, 48, 48, NULL, NULL, 'Psychic', NULL, 61, 201, 'Psybeam', 'Confusion', 'Psychic', 'Confusion'),
(5156, 'Unown (P)', 72, 72, 48, 48, 48, 48, NULL, NULL, 'Psychic', NULL, 61, 201, 'Confusion', 'Dream Eater', 'Confusion', 'Dream Eater'),
(5157, 'Unown (Q)', 72, 72, 48, 48, 48, 48, NULL, NULL, 'Psychic', NULL, 61, 201, 'Confusion', 'Confusion', 'Confusion', 'Dream Eater'),
(5158, 'Unown (R)', 72, 72, 48, 48, 48, 48, NULL, NULL, 'Psychic', NULL, 61, 201, 'Psychic', 'Psychic', 'Confusion', 'Dream Eater'),
(5159, 'Unown (S)', 72, 72, 48, 48, 48, 48, NULL, NULL, 'Psychic', NULL, 61, 201, 'Dream Eater', 'Psybeam', 'Confusion', 'Psybeam'),
(5160, 'Unown (T)', 72, 72, 48, 48, 48, 48, NULL, NULL, 'Psychic', NULL, 61, 201, 'Confusion', 'Psybeam', 'Confusion', 'Dream Eater'),
(5161, 'Unown (U)', 72, 72, 48, 48, 48, 48, NULL, NULL, 'Psychic', NULL, 61, 201, 'Confusion', 'Psybeam', 'Dream Eater', 'Psybeam'),
(5162, 'Unown (V)', 72, 72, 48, 48, 48, 48, NULL, NULL, 'Psychic', NULL, 61, 201, 'Psychic', 'Dream Eater', 'Confusion', 'Psybeam'),
(5163, 'Unown (W)', 72, 72, 48, 48, 48, 48, NULL, NULL, 'Psychic', NULL, 61, 201, 'Confusion', 'Psybeam', 'Dream Eater', 'Dream Eater'),
(5164, 'Unown (X)', 72, 72, 48, 48, 48, 48, NULL, NULL, 'Psychic', NULL, 61, 201, 'Confusion', 'Psybeam', 'Dream Eater', 'Confusion'),
(5165, 'Unown (Y)', 72, 72, 48, 48, 48, 48, NULL, NULL, 'Psychic', NULL, 61, 201, 'Psybeam', 'Dream Eater', 'Dream Eater', 'Dream Eater'),
(5166, 'Unown (Z)', 72, 72, 48, 48, 48, 48, NULL, NULL, 'Psychic', NULL, 61, 201, 'Dream Eater', 'Confusion', 'Confusion', 'Confusion'),
(5167, 'Unown (Qm)', 72, 72, 48, 48, 48, 48, NULL, NULL, 'Psychic', NULL, 61, 201, 'Dream Eater', 'Psybeam', 'Psybeam', 'Confusion'),
(5168, 'Goomy', 50, 55, 35, 75, 45, 40, 'none', 0, 'Dragon', NULL, 0, 704, 'Body Slam', 'Absorb', 'Tackle', 'Bite'),
(5170, 'Goodra', 100, 110, 70, 150, 90, 100, 'none', NULL, 'Dragon', '', 0, 706, 'Earthquake', 'Scratch', 'Bubble', 'Razor Leaf'),
(5171, 'Sliggoo', 75, 83, 53, 113, 68, 60, 'none', NULL, 'Dragon', '', 0, 705, 'Dizzy Punch', 'Scratch', 'Bubble', 'Razor Leaf'),
(5172, 'Greninja', 95, 103, 67, 71, 72, 122, 'none', NULL, 'Water', 'Dark', 0, 658, 'Fire Blast', 'Scratch', 'Bubble', 'Razor Leaf'),
(5173, 'Eevsol', 100, 100, 100, 100, 100, 100, 'none', NULL, 'Normal', '', 0, 5002, 'Fire Blast', 'Scratch', 'Bubble', 'Razor Leaf'),
(5174, 'Yvetal', 131, 131, 95, 98, 126, 99, 'none', NULL, 'Dark', 'Flying', 0, 717, 'Fire Blast', 'Scratch', 'Bubble', 'Razor Leaf'),
(5175, 'Fennekin', 80, 80, 80, 80, 80, 80, 'Braixen', 36, 'Fire', NULL, 64, 5175, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(5176, 'Braixen', 80, 80, 80, 80, 80, 80, 'Delphox', 55, 'Fire', 'Psychic', 64, 5176, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(5177, 'Delphox', 100, 100, 100, 100, 100, 100, 'none', NULL, 'Fire', 'Psychic', 64, 5177, 'Shadow Armlet', 'Scratch', 'Scratch', 'Scratch'),
(5178, 'Bunnelby', 60, 60, 60, 60, 60, 60, 'Diggersby\r\n', 22, 'Normal', 'Ground', 64, 5178, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(5179, 'Diggersby\r\n', 90, 90, 40, 50, 90, 90, 'none', NULL, 'Normal', 'Ground', 64, 5179, 'Shadow Armlet', 'Scratch', 'Scratch', 'Scratch'),
(5180, 'Fletchling', 50, 50, 50, 50, 50, 50, 'Fletchinder', 18, 'Fire', NULL, 64, 5180, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(5181, 'Fletchinder', 80, 80, 80, 80, 80, 80, 'Talonflame', 55, 'Fire', 'Flying', 64, 5181, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(5182, 'Talonflame', 120, 120, 120, 120, 120, 120, 'none', NULL, 'Fire', 'Flying', 64, 5182, 'Shadow Armlet', 'Scratch', 'Scratch', 'Scratch'),
(5183, 'Scatterbug', 40, 40, 40, 40, 40, 40, 'Spewpa', 8, 'Bug', NULL, 64, 5183, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(5184, 'Spewpa', 70, 70, 70, 70, 70, 70, 'Vivillon', 12, 'Bug', NULL, 64, 5184, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(5185, 'Vivillon', 90, 90, 90, 90, 90, 90, 'none', NULL, 'Bug', 'Flying', 64, 5185, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(5186, 'Espurr', 75, 55, 83, 44, 80, 56, 'Meowstic', 25, 'Psychic', NULL, 64, 5186, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(5187, 'Meowstic', 83, 88, 90, 100, 100, 102, 'none', NULL, 'Psychic', NULL, 64, 5187, 'Psychic', 'Scratch', 'Scratch', 'Scratch'),
(5188, 'Eeveon', 100, 120, 90, 90, 88, 120, 'none', NULL, 'Grass', 'Water', 64, 5188, 'Shadow Armlet', 'Shadow Armlet', 'Shadow Armlet', 'Shadow Armlet'),
(5189, 'Blaziken (Mega)', 180, 100, 200, 200, 200, 150, 'none', NULL, 'Fire', 'Flying', 64, 5189, 'Shadow Armlet', 'Shadow Armlet', 'Shadow Armlet', 'Shadow Armlet'),
(5190, 'Feekarp', 80, 80, 80, 80, 80, 80, 'Gyaratic', 20, 'Water', 'Dragon', 64, 5190, 'Shadow Armlet', 'Shadow Armlet', 'Scratch', 'Scratch'),
(5191, 'Gyaratic', 180, 120, 150, 120, 180, 130, 'none', NULL, 'Water', 'Dragon', 64, 5191, 'Shadow Armlet', 'Shadow Armlet', 'Shadow Armlet', 'Shadow Armlet'),
(5192, 'Mogos', 120, 90, 120, 90, 150, 85, 'none', NULL, 'Fire', 'Dragon', 64, 5192, 'Shadow Armlet', 'Scratch', 'Scratch', 'Scratch'),
(5193, 'Zaygos', 120, 90, 120, 100, 150, 100, 'none', 0, 'Dragon', NULL, 64, 5193, 'Shadow Armlet', 'Scratch', 'Scratch', 'Scratch'),
(5194, 'Artygos', 120, 100, 90, 90, 180, 120, 'none', NULL, 'Ice', 'Dragon', 64, 5194, 'Shadow Armlet', 'Scratch', 'Scratch', 'Scratch'),
(5195, 'Darkcune', 100, 100, 100, 80, 120, 140, 'none', NULL, 'Water', 'Dark', 64, 5195, 'Shadow Armlet', 'Shadow Armlet', 'Shadow Armlet', 'Shadow Armlet'),
(5196, 'Mewtwo (Mega)', 140, 150, 150, 150, 150, 150, 'none', NULL, 'Psychic', 'Dark', 64, 5196, 'Shadow Armlet', 'Scratch', 'Scratch', 'Scratch'),
(5197, 'Aggron (Mega)', 100, 100, 120, 150, 150, 100, 'none', NULL, 'Rock', 'Steel', 64, 5197, 'Shadow Armlet', 'Scratch', 'Scratch', 'Scratch'),
(5199, 'Pikakip', 60, 50, 80, 50, 80, 100, 'Pikatomp', 35, 'Electric', 'Ground', 64, 5199, 'Shadow Armlet', 'Shadow Armlet', 'Shadow Armlet', 'Shadow Armlet'),
(5200, 'Pikatomp', 90, 90, 90, 90, 90, 120, 'Raipert', 55, 'Electric', 'Ground', 64, 5200, 'Shadow Armlet', 'Shadow Armlet', 'Shadow Armlet', 'Shadow Armlet'),
(5201, 'Raipert', 100, 120, 100, 80, 90, 150, 'none', NULL, '', NULL, 64, 5201, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(5202, 'Darkmuj', 130, 100, 90, 130, 100, 180, 'none', NULL, 'Dark', 'Ice', 64, 5202, 'Shadow Armlet', 'Scratch', 'Scratch', 'Scratch'),
(5203, 'Alakazam (Mega)', 130, 120, 120, 110, 130, 90, 'none', NULL, 'Psychic', 'Dark', 64, 5203, 'Psychic', 'Shadow Armlet', 'Scratch', 'Scratch'),
(5204, 'Tyrunt', 70, 85, 90, 90, 85, 99, 'Tyrantrum', 55, 'Dragon', 'Rock', 64, 5204, 'Shadow Armlet', 'Shadow Armlet', 'Scratch', 'Scratch'),
(5205, 'Tyrantrum', 100, 99, 105, 120, 150, 50, 'none', NULL, 'Dragon', 'Rock', 64, 5205, 'Shadow Armlet', 'Scratch', 'Scratch', 'Scratch'),
(5206, 'Godtwo', 280, 200, 200, 200, 220, 250, 'none', NULL, 'God', 'God', 64, 5206, 'Heavenly Strike', 'Heavenly Strike', 'God Armlet', 'God Armlet'),
(5207, 'Gengar (Mega)', 100, 120, 120, 110, 90, 100, 'none', NULL, 'Ghost', 'Dark', 64, 5207, 'Shadow Armlet', 'Scratch', 'Scratch', 'Scratch'),
(5208, 'Tyranita (Mega)', 120, 120, 150, 110, 130, 80, 'none', NULL, 'Dark', 'Rock', 64, 5208, 'Shadow Armlet', 'Shadow Armlet', 'Shadow Armlet', 'Shadow Armlet'),
(5209, 'Gyarados (Mega)', 135, 150, 100, 100, 130, 80, 'none', NULL, 'Dark', 'Dragon', 64, 5209, 'Shadow Armlet', 'Shadow Armlet', 'Shadow Armlet', 'Shadow Armlet'),
(5210, 'Arceus (God)', 155, 150, 200, 200, 200, 210, 'none', 64, 'God', 'God', 64, 5209, 'Shadow Armlet', 'Scratch', 'Scratch', 'Scratch'),
(5211, 'Palkius (God)', 200, 150, 155, 150, 180, 200, 'none', NULL, 'God', 'God', 64, 5211, 'Shadow Armlet', 'Scratch', 'Scratch', 'Scratch'),
(5212, 'Alakazam (Mega)', 100, 100, 90, 120, 140, 90, 'none', NULL, 'Psychic', 'Dark', 64, 5212, 'Shadow Armlet', 'Scratch', 'Scratch', 'Scratch'),
(5213, 'Banette (Mega)', 90, 100, 120, 120, 90, 90, 'none', NULL, 'Dark', 'Ghost', 64, 5213, 'Shadow Armlet', 'Scratch', 'Scratch', 'Scratch'),
(5214, 'Blastoise (Mega)', 120, 120, 100, 80, 130, 80, 'none', NULL, 'Water', 'Water', 0, 5214, 'Shadow Armlet', 'Scratch', 'Scratch', 'Scratch'),
(5215, 'Mewtwo (Armor)', 140, 140, 120, 100, 120, 140, 'none', NULL, 'Psychic', 'Dark', 64, 5215, 'Shadow Armlet', 'Scratch', 'Scratch', 'Scratch'),
(5216, 'Demondile', 70, 80, 70, 100, 70, 100, 'Demonaw', 3000, 'Fire', 'Water', 64, 5216, 'Shadow Armlet', 'Shadow Armlet', 'Scratch', 'Scratch'),
(5217, 'Demonaw', 100, 100, 100, 100, 90, 110, 'Demonzard', 3500, 'Fire', 'Dragon', 64, 5217, 'Shadow Armlet', 'Scratch', 'Scratch', 'Scratch'),
(5218, 'Demonzard', 120, 120, 140, 120, 120, 150, 'none', NULL, 'Dragon', 'Fire', 65, 5218, 'Shadow Armlet', 'Scratch', 'Scratch', 'Scratch');
INSERT INTO `pokedex` (`id`, `name`, `attack`, `spattack`, `def`, `spdef`, `hp`, `speed`, `evolution`, `level`, `type1`, `type2`, `exp`, `num`, `move1`, `move2`, `move3`, `move4`) VALUES
(5219, 'Solarsor', 100, 105, 100, 120, 95, 150, 'none', NULL, 'Electric', 'Bug', 64, 5219, 'Shadow Armlet', 'Shadow Armlet', 'Shadow Armlet', 'Shadow Armlet'),
(5220, 'Lightsor', 100, 100, 100, 80, 100, 150, 'none', NULL, 'Fire', 'Bug', 64, 5220, 'Shadow Armlet', 'Shadow Armlet', 'Shadow Armlet', 'Shadow Armlet'),
(5221, 'Darksor', 120, 90, 120, 90, 95, 180, 'none', NULL, 'Dark', 'Bug', 64, 5221, 'Shadow Armlet', 'Shadow Armlet', 'Shadow Armlet', 'Shadow Armlet'),
(5222, 'Ampharos (Mega)', 120, 100, 100, 90, 100, 100, 'none', NULL, 'Electric', 'Normal', 64, 5222, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(5223, 'Kyurem (White)', 100, 100, 100, 100, 100, 100, 'none', NULL, 'Dragon', 'Ice', 64, 5223, 'Shadow Armlet', 'Shadow Armlet', 'Scratch', 'Scratch'),
(5224, 'Kyurem (Black)', 100, 100, 100, 100, 100, 100, 'none', NULL, 'Dragon', 'Ice', 64, 5224, 'Shadow Armlet', 'Shadow Armlet', 'Scratch', 'Scratch'),
(5225, 'Yveltal', 100, 100, 100, 100, 100, 100, 'none', NULL, 'Dragon', 'Ice', 64, 5225, 'Shadow Armlet', 'Shadow Armlet', 'Scratch', 'Scratch'),
(5226, 'Xerneas', 100, 100, 100, 100, 100, 100, 'none', NULL, 'Dragon', 'Ice', 64, 5226, 'Shadow Armlet', 'Shadow Armlet', 'Scratch', 'Scratch'),
(5227, 'Zygarde', 100, 100, 100, 100, 100, 100, 'none', NULL, 'Dragon', 'Ice', 64, 5227, 'Shadow Armlet', 'Shadow Armlet', 'Scratch', 'Scratch'),
(5228, 'Asdd', 40, 40, 40, 40, 40, 40, 'none', NULL, 'Ghost', 'Ghost', 64, 5228, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(5229, 'Ghost', 40, 40, 40, 40, 40, 40, 'none', NULL, 'Ghost', 'Ghost', 64, 5229, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(5230, 'Tornadus (Therian)', 100, 100, 100, 100, 100, 100, 'none', NULL, 'Normal', 'Flying', 64, 5230, 'Shadow Armlet', 'Scratch', 'Scratch', 'Scratch'),
(5231, 'Landorus (Therian)', 100, 100, 100, 100, 100, 100, 'none', NULL, 'Normal', 'Flying', 64, 5231, 'Shadow Armlet', 'Scratch', 'Scratch', 'Scratch'),
(5232, 'Thundurus (Therian)', 100, 100, 100, 100, 100, 100, 'none', NULL, 'Electric', 'Electric', 64, 5232, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(5233, 'Aceoxys', 150, 120, 140, 130, 140, 150, 'none', NULL, 'Psychic', 'Normal', 64, 5233, 'Scratch', 'Scratch', 'Scratch', 'Scratch'),
(5234, 'Rayquaza (Darkness)', 150, 150, 100, 100, 130, 180, 'none', NULL, 'Dark', 'Dragon', 64, 5234, 'Shadow Armlet', 'Scratch', 'Scratch', 'Scratch'),
(5235, 'Rayquaza (Justicar)', 150, 150, 100, 100, 120, 180, 'none', NULL, 'Flying', 'Dragon', 64, 5235, 'Shadow Armlet', 'Scratch', 'Scratch', 'Scratch'),
(5236, 'Gardevoir (Mega)', 120, 120, 120, 120, 100, 130, 'none', NULL, 'Psychic', 'Psychic', 64, 5236, 'Shadow Armlet', 'Scratch', 'Scratch', 'Scratch'),
(5237, 'Tyranitar (Mega)', 130, 130, 100, 80, 130, 80, 'none', NULL, 'Ground', 'Dragon', 64, 5237, 'Shadow Armlet', 'Scratch', 'Scratch', 'Scratch'),
(5238, 'Venasaur (Mega)', 120, 120, 120, 80, 120, 80, 'none', NULL, 'Grass', 'Grass', 64, 5238, 'Shadow Armlet', 'Scratch', 'Scratch', 'Scratch'),
(5239, 'Metagross (Mega)', 150, 150, 120, 140, 140, 100, 'none', NULL, 'Psychic', 'Steel', 64, 5239, 'Shadow Armlet', 'Scratch', 'Scratch', 'Scratch'),
(5241, 'Heracross (Mega)', 120, 120, 100, 120, 140, 180, 'none', NULL, 'Bug', 'Fighting', 64, 5241, 'Shadow Armlet', 'Scratch', 'Scratch', 'Scratch'),
(5242, 'Scizor (Mega)', 140, 140, 100, 120, 100, 180, 'none', NULL, 'Bug', 'Steel', 64, 5242, 'Shadow Armlet', 'Scratch', 'Scratch', 'Scratch'),
(5243, 'Deoxys (Mecha)', 180, 180, 180, 180, 250, 180, 'none', NULL, 'Psychic', 'Steel', 64, 5243, 'Shadow Armlet', 'Scratch', 'Scratch', 'Scratch'),
(5244, 'Xsor', 150, 150, 150, 150, 150, 280, 'none', NULL, 'Grass', 'Bug', 64, 5244, 'Shadow Armlet', 'Scratch', 'Scratch', 'Scratch');
...
CREATE TABLE IF NOT EXISTS `pokemon` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci AUTO_INCREMENT=5152 ;
...
CREATE TABLE IF NOT EXISTS `sale_pokemon` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL,
  `username` varchar(30) COLLATE latin1_general_ci NOT NULL,
  `price` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `send_money_history` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `sender_uid` int(11) NOT NULL,
  `recipient_uid` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `shop_pokemon` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `token_shop` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(200) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `token_shop_pokemon` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(200) NOT NULL,
  `price` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
