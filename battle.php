...
function clacDamage($poke1, $poke2, $moveUsed) {
	...
	$messages = array(
		'msg-0'    => 'It doesn\'t affect '.$poke2['name'].'...',
		'msg-0.25' => 'It\'s not very effective...',
		'msg-0.5'  => 'It\'s not very effective...',
		'msg-1'    => '',
		'msg-2'    => 'It\'s super effective!',
		'msg-4'    => 'It\'s super effective!'
	);
	...
	//if (/*$opponentTeam[$onum]['hp'] > 0 && $myTeam[$pnum]['hp'] > 0 && */ $_SESSION['battle']['screen'] != 'caughtpokemon') {
		if ((isset($omoveUsed, $odamageDone) || isset($moveUsed, $damageDone) || isset($itemMsg)) && $_SESSION['battle']['screen'] != 'caughtpokemon') {
			...
			if (isset($omoveUsed, $odamageDone)) {
				echo '<td>'.$opponentTeam[$onum]['name'].' used '.$omoveUsed.'<br /> and did '.$odamageDone.' damage.';
			...
			if (isset($moveUsed, $damageDone)) {
				echo '<td>'.$myTeam[$pnum]['name'].' used '.$moveUsed.'<br /> and did '.$damageDone.' damage';
