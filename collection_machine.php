...
include '_header.php';
printHeader('Collection Machine');
...
foreach ($rewards as $key => $reward) {
	...
	echo '
		If you collect '.$reward['required_amount'].' '.$reward['required_pokemon'].'
		you get the oppotunity to trade them for a '.$reward['reward_pokemon'].'!<br />
		You have '.$numPokes.'/'.$reward['required_amount'].'.<br />
		<img src="images/pokemon/'.$reward['reward_pokemon'].'.png" alt="'.$reward['reward_pokemon'].'" />
	';
	...
	if ($numPokes >= $reward['required_amount']) {
		echo '
			<form action="" method="post">
				...
				<input type="submit" id="button" name="trade" value="Trade for '.$reward['reward_pokemon'].'!" />
			</form>
		';
	}
	echo '<br /><br />';
