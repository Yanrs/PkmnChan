...
die('This pokemon either dosn\'t exist or isn\'t yours.');
}
...
<td colspan="3">
<a href="" style="font-size: 12px;" onclick="showMoves(\''.$id.'\'); return false;">Show all moves ('.  (count($moves)-10) . ' are hidden)</a>
</td>
</tr>
';
...
echo '
<br /><br /><input type="submit" value="Change Attack" /><br /><br /></form>
